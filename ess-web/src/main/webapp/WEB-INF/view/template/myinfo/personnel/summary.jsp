    ...
    <div class="grid" style="background:white;">
        <div class="col-1-2 content-container content-controls padding-10">
            ...
            <table class="simple-table">
                ...
                <tr><td>Marital Status</td><td>{{state.emp.snapshot['CDMARITALST'].value}}</td></tr>
                </tbody>
            </table>
        </div>
        <div class="col-1-2 content-container content-controls padding-10">
            ...
            <table class="simple-table">
                ...
                <tr><td>Federal Exemptions</td><td>{{state.emp.snapshot['NUFEDTAXEX'].value}}</td></tr>
            ...
            <table class="simple-table">
                <tbody>
                <tr><td>Responsibility Center</td><td>{{state.emp.respCtr.name}}</td></tr>
                <tr><td>Agency Code</td><td>{{state.emp.respCtr.agencyCode}}</td></tr>
                <tr><td>Agency Name</td><td>{{state.emp.respCtr.agencyName}}</td></tr>
                ...
                <tr><td>Negotiation Unit</td><td>{{state.emp.snapshot['CDNEGUNIT'].value}}</td></tr>
                </tbody>
            </table>
        </div>
    </div>
