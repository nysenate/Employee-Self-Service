...
<!--[if lte IE 8]>
<script type="text/javascript" src="${ctxPath}/assets/js/dest/timesheets-vendor-ie.min.js?v=${releaseVersion}"/></script>
<![endif]-->
...
<c:choose>
    <c:when test="${runtimeLevel eq 'dev'}">
        ...
        <script type="text/javascript" src="${ctxPath}/assets/js/src/common/not-filter.js?v=${releaseVersion}"></script>
        <script type="text/javascript"
        ...
        <script type="text/javascript" src="${ctxPath}/assets/js/src/common/ai-filter.js?v=${releaseVersion}"></script>
        <script type="text/javascript"
