...
public class SupervisorEmpGroupTests
{
    ...
    public void testGetAllEmployees() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            empGroup.primaryEmployees.put(i, new EmployeeSupInfo(i, 1000, date, date));
            empGroup.overrideEmployees.put(1001 + i, new EmployeeSupInfo(1001 + i, 1000, date, date));
            empGroup.supOverrideEmployees.put(2000, 2001 + i, new EmployeeSupInfo(2001 + i, 2000, date, date));
            empGroup.supOverrideEmployees.put(3000, 3001 + i, new EmployeeSupInfo(3001 + i, 3000, date, date));
        }
