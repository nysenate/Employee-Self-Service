...
public class EverfiUpdateUserRequest {
    ...
    public EverfiUpdateUserRequest(EverfiApiClient everfiClient, String empUuid, String firstName, String lastName,
                                   String email, String ssoId, int employeeId, List<EverfiCategoryLabel> categoryLabels) {
