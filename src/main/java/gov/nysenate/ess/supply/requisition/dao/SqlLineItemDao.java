...
public class SqlLineItemDao extends SqlBaseDao {
    ...
    private static class ReqLineItemHandler extends BaseHandler {
        ...
        private final SupplyItemDao itemDao;
        private final Map<Integer, Integer> itemIdToCounts;

        private final Comparator<LineItem> alphabeticalItemDesc = Comparator.comparing(o -> o.getItem().getDescription());
