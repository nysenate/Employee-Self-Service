...
public enum OracleSupplyItemQuery implements BasicSqlQuery {
    ...
    GET_SUPPLY_ITEM_BY_ID(
            "Select com.Nuxrefco, xref.CdCommodity, com.CdCategory, com.CdIssUnit, com.DeCommodityf, com.DeCommdtyEssSupply, \n" +
            "com.CdSpecPerMReq, com.CdSpecPerMVisible, unit.AmStdUnit, com.numaxunitord, com.numaxunitmon, com.cdsensuppieditem \n" +
            ...
            "Where com.CdStatus = 'A' AND (com.CdStockItem = 'Y' OR com.cdsensuppieditem = 'Y') AND com.Nuxrefco = :id"
    ),
    ...
    GET_ALL_ITEMS_BODY(
            ...
            "Inner Join ${masterSchema}.FM12COMXREF xref On com.Nuxrefco = xref.Nuxrefco \n" +
            "Inner Join ${masterSchema}.FL12STDUNIT unit On com.CdIssUnit = unit.CdStdUnit \n" +
            "Where com.CdStatus= 'A' And (com.CdStockItem= 'Y' OR com.cdsensuppieditem = 'Y')"
    ),
    ...
    GET_ITEMS_BY_CATEGORY_BODY(
            ...
            "Inner Join ${masterSchema}.FM12COMXREF xref On com.Nuxrefco = xref.Nuxrefco \n" +
            "Inner Join ${masterSchema}.FL12STDUNIT unit On com.CdIssUnit = unit.CdStdUnit \n" +
            "Where com.CdStatus= 'A' And (com.CdStockItem = 'Y' OR com.cdsensuppieditem = 'Y') AND com.CdCategory IN (:categories)"
    ),
