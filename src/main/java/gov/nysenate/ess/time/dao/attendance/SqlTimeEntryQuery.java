...
public enum SqlTimeEntryQuery implements BasicSqlQuery
{
    ...
    INSERT_TIME_ENTRY(
        ...
        "       NUMISC, NUXRMISC, NUMISC2, NUXRMISC2, CDSTATUS, DECOMMENTS, CDPAYTYPE, NUVACATION, NUPERSONAL,\n" +
        "       NATXNORGUSER, NATXNUPDUSER, NAUSER)\n" +
        "VALUES (:timesheetId, :empId, :dayDate, :workHR, :travelHR, :holidayHR, :sickEmpHR, :sickFamilyHR, \n" +
        "        :miscHR, :miscTypeId, :misc2HR, :miscType2Id, :status, :empComment, :payType, :vacationHR, :personalHR, \n" +
    ...
    UPDATE_TIME_ENTRY(
        ...
        "   NUXRMISC = :miscTypeId, NUMISC2 = :misc2HR, NUXRMISC2 = :miscType2Id, CDSTATUS = :status, DECOMMENTS = :empComment,\n" +
