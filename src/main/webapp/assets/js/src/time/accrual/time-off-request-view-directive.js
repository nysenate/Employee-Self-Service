...
essTime.directive('timeOffRequestView', ['appProps', 'UpdateAccrualRequestsApi', 'AccrualRequestApi', 'EmployeeInfoApi',
...
/*
    ...
    */
function requestViewDirective(appProps, UpdateAccrualRequestsApi, AccrualRequestApi, EmployeeInfoApi, AccrualApi, HolidayApi, PayPeriodApi, TimeOffRequestValidationService) {
    return {
        scope: {
            data: '=',
            mode: '=',
        ...
        link: function ($scope) {
            ...
            $scope.saveRequest = function () {
                ...
                if ($scope.validate()) {
                    ...
                    UpdateAccrualRequestsApi.save(sendObject).$promise
                        .then(
                            //on success
                            function (data) {
                                $scope.pageLoaded = false;
            ...
            $scope.updateData = function (requestId) {
                AccrualRequestApi.get({requestId: requestId}).$promise.then(
                    //success
                    function (data) {
