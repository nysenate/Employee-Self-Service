 ...
 * @param supOverrideApi
 * @returns {{}}
 */
angular.module('essTime').factory('supEmpGroupService', [
    '$filter', '$q', 'appProps', 'modals', 'RestErrorService', 'SupervisorEmployeesApi', 'SupervisorOverridesApi',
    function ($filter, $q, appProps, modals, RestErrorService, supEmployeeApi, supOverrideApi) {
        ...
        function loadSupEmpGroup() {
            ...
            return supEmployeeApi.get(params, onSuccess, RestErrorService.handleErrorResponse).$promise;
        }
        ...
        function loadSupOverrides() {
            ...
            return supOverrideApi.get(params, onSuccess, RestErrorService.handleErrorResponse).$promise;
        }
