...
essApi.factory('TravelTransportationAllowanceApi', ['$resource', 'appProps', function ($resource, appProps) {
    return $resource(appProps.apiPath + '/travel/transportation-allowance')
}]);
