...
function(e) {
...
}(jQuery), function(O, U, t) {
    function J(b) {
        return function() {
            var c, a = arguments[0];
            for (c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.4.2/" + (b ? b + "/" : "") + a, 
    ...
    function Nc(b, a) {
        ...
        if (Tb.test(b)) {
            for (c = c || e.appendChild(a.createElement("div")), d = (Bf.exec(b) || [ "", "" ])[1].toLowerCase(), 
            d = na[d] || na._default, c.innerHTML = d[1] + b.replace(Cf, "<$1></$2>") + d[2], 
    ...
    function vb(b, a) {
        ...
        return a && !c && (b.ng339 = c = ++Ef, c = ib[c] = {
            events: {},
            data: {},
            handle: t
        }), c;
        ...
        this.debugInfoEnabled = function(a) {
            ...
            function E(a, b, d, e, f, g, h, k, s) {
                ...
                for (var E, w, v, Aa, F = -Number.MAX_VALUE, $ = s.newScopeDirective, N = s.controllerDirectives, u = s.newIsolateScopeDirective, D = s.templateDirective, m = s.nonTlbTranscludeDirective, K = !1, I = !1, q = s.hasElementTranscludeDirective, ba = d.$$element = y(b), A = e, xa = 0, Ta = a.length; Ta > xa; xa++) {
                    ...
                    S = Mf(a.splice(xa, a.length - xa), ba, d, f, K && A, h, k, {
        ...
        this.register = function(a, d) {
            ...
            return function(f, g, h, l) {
                ...
                if (h = !0 === h, l && L(l) && (r = l), L(f)) {
                    if (l = f.match(Xc), !l) throw Of("ctrlfmt", f);
    ...
    function $b(b, a) {
        if (L(b)) {
            ...
            if (c) {
                ...
                (d = d && 0 === d.indexOf(cd)) || (d = (d = c.match(Qf)) && Rf[d[0]].test(c)), d && (b = wc(c));
            }
        }
        return b;
    }
    ...
    function hd(b, a) {
        var c = Ba(b);
        a.$$protocol = c.protocol, a.$$host = c.hostname, a.$$port = W(c.port) || Uf[c.protocol] || null;
    }
    function id(b, a) {
        var c = "/" !== b.charAt(0);
        c && (b = "/" + b);
    ...
    function Lc(b) {
        ...
        } ], a("currency", yd), a("date", zd), a("filter", ag), a("json", bg), a("limitTo", cg), 
        a("lowercase", dg), a("number", Ad), a("orderBy", Bd), a("uppercase", eg);
    }
    function ag() {
    ...
    function zd(b) {
        ...
        return function(c, e, f) {
            var l, k, g = "", h = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, L(c) && (c = gg.test(c) ? W(c) : a(c)), 
            ...
            return f && (n = xc(f, c.getTimezoneOffset()), c = Pb(c, f, !0)), m(h, function(a) {
                l = ig[a], g += l ? l(c, b.DATETIME_FORMATS, n) : a.replace(/(^'|'$)/g, "").replace(/''/g, "'");
            }), g;
        };
    }
    function bg() {
    ...
    var Ua, y, la, gb, kg = /^\/(.+)\/([a-z]*)$/, M = function(b) {
        return L(b) ? b.toLowerCase() : b;
    }, Xa = Object.prototype.hasOwnProperty, rb = function(b) {
        return L(b) ? b.toUpperCase() : b;
    }, za = [].slice, Nf = [].splice, lg = [].push, sa = Object.prototype.toString, sc = Object.getPrototypeOf, Fa = J("ng"), ca = O.angular || (O.angular = {}), nb = 0;
        ...
        on: function a(c, d, e, f) {
            ...
            if (Mc(c)) {
                ...
                for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [ d ], l = g.length; l--; ) {
                    d = g[l];
                    var k = f[d];
                    k || (f[d] = [], "mouseenter" === d || "mouseleave" === d ? a(c, mg[d], function(a) {
    ...
    } ], Wc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, ng = /,/, og = /^\s*(_?)(\S+?)\1\s*$/, Vc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ha = J("$injector");
        ...
        if ("function" == typeof a) {
            if (!(e = a.$inject)) {
                if (e = [], a.length) {
                    ...
                    c = a.toString().replace(Vc, ""), c = c.match(Wc), m(c[1].split(ng), function(a) {
    ...
    var Zc = /^((?:x|data)[\:\-_])/i, Of = J("$controller"), Xc = /^(\S+)(\s+as\s+(\w+))?$/, cd = "application/json", ac = {
    ...
    gc.prototype = {
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length; ) {
                ...
                this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += rg[g] || g, f = !1; else if ("\\" === g) f = !0; else {
    ...
    m(Ab, function(a, c) {
        ...
        sb[c] = function() {
            return {
                priority: 100,
                link: function(a, e, f) {
                    return "ngPattern" === c && "/" == f.ngPattern.charAt(0) && (e = f.ngPattern.match(kg)) ? void f.$set("ngPattern", new RegExp(e[1], e[2])) : void a.$watch(f[c], function(a) {
                        f.$set(c, a);
                    });
                }
            };
    ...
    }, je = Od(), we = Od(!0), jg = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, sg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, tg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, ug = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, Pd = /^(\d{4})-(\d{2})-(\d{2})$/, Qd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, mc = /^(\d{4})-W(\d\d)$/, Rd = /^(\d{4})-(\d\d)$/, Sd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Td = {
    ...
    var ye = [ "$animate", function(a) {
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, c) {
                ...
                this.$options.updateOn = R(this.$options.updateOn.replace(yg, function() {
        ...
        terminal: !0,
        priority: 1e3
    }), zg = J("ngOptions"), Ag = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, Je = [ "$compile", "$parse", function(a, c) {
        function d(a, d, e) {
        ...
        var e = this, f = new Sa();
        e.ngModelCtrl = Bg, e.unknownOption = y(U.createElement("option")), e.renderUnknownOption = function(c) {
...
function(p, c, C) {
            ...
            function w(y, g, l, m) {
                ...
                return l = s({}, f.defaults.actions, l), e.prototype.toJSON = function() {
                    ...
                    e[k] = function(a, z, m, y) {
                        ...
                        var u = this instanceof e, p = u ? f : b.isArray ? [] : new e(f), t = {}, w = b.interceptor && b.interceptor.response || F, C = b.interceptor && b.interceptor.responseError || B;
                        return r(b, function(b, a) {
                            "params" != a && "isArray" != a && "interceptor" != a && (t[a] = H(b));
                        }), g && (t.data = f), G.setUrlParams(t, s({}, c(f, b.params || {}), n), b.url), 
                        n = q(t).then(function(a) {
                            ...
                            return p.$resolved = !0, (A || E)(a), h.reject(a);
                        }), n = n.then(function(a) {
                            var b = w(a);
                            return (l || E)(b, a.headers), b;
                        }, C), u ? n : (p.$promise = n, p.$resolved = !1, p);
                    }, e.prototype["$" + k] = function(a, b, c) {
                        return v(a) && (c = b, b = a, a = {}), a = e[k].call(this, a, this, b, c), a.$promise || a;
                    };
                }), e.bind = function(b) {
                    return w(y, s({}, g, b), l);
                }, e;
...
}(window, window.angular), function(F, t, W) {
    function ua(a, b, c) {
    ...
    function ba(a, b, c) {
        var d = "";
        return a = X(a) ? a : a && U(a) && a.length ? a.split(/\s+/) : [], u(a, function(a, s) {
    ...
    function Fa(a) {
        ...
        return 1 === a.nodeType ? G(a) : void 0;
    }
    function ka(a) {
        if (!a[0]) return a;
    ...
    function ha(a) {
        return function(b, c) {
            c.addClass && (Ga(a, b, c.addClass), c.addClass = null), c.removeClass && (Ha(a, b, c.removeClass), 
            c.removeClass = null);
        };
    }
    function ia(a) {
    ...
    function R(a, b, c) {
        ...
        return a = Ia(a.attr("class"), d, e), ya(b, c), b.addClass = a.addClass ? a.addClass : null, 
    ...
    function za(a, b, c) {
        ...
        return u(c, function(a, b) {
            ...
            if (c) {
                var l = c.charAt(0);
                ("-" === l || "+" === l || l >= 0) && (c = Ja(c)), 0 === c && (c = null), d[b] = c;
            }
        }), d;
    }
    function Ja(a) {
        var b = 0;
        return a = a.split(/\s*,\s*/), u(a, function(a) {
    ...
    var O, pa, V, qa, H = t.noop, ya = t.extend, G = t.element, u = t.forEach, X = t.isArray, U = t.isString, na = t.isObject, Ka = t.isUndefined, La = t.isDefined, Ca = t.isFunction, oa = t.isElement;
    F.ontransitionend === W && F.onwebkittransitionend !== W ? (O = "WebkitTransition", 
    pa = "webkitTransitionEnd transitionend") : (O = "transition", pa = "transitionend"), 
    F.onanimationend === W && F.onwebkitanimationend !== W ? (V = "WebkitAnimation", 
    qa = "webkitAnimationEnd animationend") : (V = "animation", qa = "animationend");
    ...
    t.module("ngAnimate", []).directive("ngAnimateChildren", [ function() {
        ...
        d.join.push(function(a, b, d) {
            ...
            function r(a, S, p) {
                ...
                var P, E;
                (a = Fa(a)) && (P = A(a), E = a.parent()), p = ia(p);
                var m = new z();
                if (!P) return k(), m;
                X(p.addClass) && (p.addClass = p.addClass.join(" ")), X(p.removeClass) && (p.removeClass = p.removeClass.join(" ")), 
                p.from && !na(p.from) && (p.from = null), p.to && !na(p.to) && (p.to = null);
                var e = [ P.className, p.addClass, p.removeClass ].join(" ");
                if (!v(e)) return k(), m;
                var M = 0 <= [ "enter", "move", "leave" ].indexOf(S), g = !x || L.get(P), e = !g && h.get(P) || {}, l = !!e.state;
                if (g || l && 1 == e.state || (g = !ta(a, E, S)), g) return k(), m;
                if (M && K(a), g = {
                    structural: M,
                    element: a,
                    event: S,
                    ...
                    if (b("skip", a, g, e)) return 2 === e.state ? (k(), m) : (R(a, e.options, p), e.runner);
                    if (b("cancel", a, g, e)) 2 === e.state ? e.runner.end() : e.structural ? e.close() : R(a, g.options, e.options); else if (b("join", a, g, e)) {
                        if (2 !== e.state) return S = g.event = e.event, p = R(a, e.options, g.options), 
                        m;
                        R(a, p, {});
                    }
                } else R(a, p, {});
                if ((l = g.structural) || (l = "animate" === g.event && 0 < Object.keys(g.options.to || {}).length || c(g.options)), 
                !l) return k(), C(a), m;
                M && f(E);
                var r = (e.counter || 0) + 1;
                return g.counter = r, ga(a, 1, g), s.$$postDigest(function() {
                    var b = h.get(P), v = !b, b = b || {}, e = a.parent() || [], E = 0 < e.length && ("animate" === b.event || b.structural || c(b.options));
                    v || b.counter !== r || !E ? (v && (Da(a, p), ca(a, p)), (v || M && b.event !== S) && (p.domOperation(), 
                    m.end()), E || C(a)) : (S = !b.structural && c(b.options, !0) ? "setClass" : b.event, 
            ...
            function ta(a, b, c) {
                var v, f = c = !1, d = !1;
                for ((a = a.data("$ngAnimatePin")) && (b = a); b && b.length && (f || (f = E(b, n)), 
                a = b[0], 1 === a.nodeType); ) {
                    var e = h.get(a) || {};
                    if (d || (d = e.structural || L.get(a)), (Ka(v) || !0 === v) && (a = b.data("$$ngAnimateChildren"), 
                    La(a) && (v = a)), d && !1 === v) break;
                    f || (f = E(b, n), f || (a = b.data("$ngAnimatePin")) && (b = a)), c || (c = E(b, k)), 
                    b = b.parent();
                }
                return (!d || v) && f && c;
            }
            function ga(a, b, c) {
                c = c || {}, c.state = b, a = A(a), a.setAttribute("data-ng-animate", b), c = (b = h.get(a)) ? ya(b, c) : c, 
                h.put(a, c);
            }
            ...
            return {
                ...
                pin: function(a, b) {
                    ua(oa(a), "element", "not an element"), ua(oa(b), "parentElement", "not an element"), 
                    a.data("$ngAnimatePin", b);
                },
                push: function(a, b, c, f) {
                    return c = c || {}, c.domOperation = f, r(a, b, c);
                },
        ...
        this.$get = [ "$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$rAFScheduler", function(a, e, s, n, g) {
            ...
            return function(w, B, r) {
                ...
                function C(a) {
                    var b = [], c = {};
                    u(a, function(a, f) {
                        var d = A(a.element), e = 0 <= [ "enter", "move" ].indexOf(a.event), d = a.structural ? K(d) : [];
                        if (d.length) {
                            var h = e ? "to" : "from";
                            u(d, function(a) {
                    ...
                    return u(c, function(c, e) {
                        ...
                        } else h = h ? h.animationID : k.animationID, k = h.toString(), f[k] || (f[k] = !0, 
                        b.push(a[h]));
                    }), b;
                }
                function E(a, b) {
                ...
                function h(b) {
                    w.off("$destroy", ga), w.removeData("$$animationRunner"), D(w, r), ca(w, r), r.domOperation(), 
                    k && a.removeClass(w, k), w.removeClass("ng-animate"), x.complete(!b);
                }
                r = ia(r);
                ...
                return L || (m = z, z += 1), l.push({
                    ...
                    close: h
                }), w.on("$destroy", ga), 1 < l.length ? x : (e.$$postDigest(function() {
                    Z = z, z = 0, I.length = 0;
                    var a = [];
                    u(l, function(c) {
        ...
        this.$get = [ "$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$document", "$sniffer", "$$rAFScheduler", function(a, e, s, n, g, l, D) {
            ...
            function Z(g, f, B, l) {
                var h;
                return 0 < b.count(B) && (h = c.get(B), h || (f = ba(f, "-stagger"), e.addClass(g, f), 
                h = za(a, g, l), h.animationDuration = Math.max(h.animationDuration, 0), h.transitionDuration = Math.max(h.transitionDuration, 0), 
                e.removeClass(g, f), c.put(B, h))), h || {};
            }
            function I(a) {
            ...
            function w(c, f, e) {
                return f = b.get(e), f || (f = za(a, c, Ma), "infinite" === f.animationIterationCount && (f.animationIterationCount = 1)), 
            ...
            return function(a, c) {
                ...
                function h(b) {
                    K || C && D || (K = !0, D = !1, e.removeClass(a, Y), e.removeClass(a, W), ma(k, !1), 
                    ja(k, !1), u(m, function(a) {
                        k.style[a[0]] = "";
                    }), B(a, c), ca(a, c), c.onDone && c.onDone(), p && p.complete(!b));
                }
                function L(a) {
                ...
                function M() {
                    function b() {
                        if (!K) {
                            if (L(!1), u(m, function(a) {
                                k.style[a[0]] = a[1];
                            }), B(a, c), e.addClass(a, W), q.recalculateTimingStyles) {
                                if (fa = k.className + " " + Y, $ = z(k, fa), y = w(k, fa, $), Q = y.maxDelay, H = Math.max(Q, 0), 
                                J = y.maxDuration, 0 === J) return void h();
                            ...
                            if (q.applyTransitionDelay || q.applyAnimationDelay) {
                                Q = "boolean" != typeof c.delay && la(c.delay) ? parseFloat(c.delay) : Q, H = Math.max(Q, 0);
                                var l;
                                q.applyTransitionDelay && (y.transitionDelay = Q, l = [ ea, Q + "s" ], m.push(l), 
                                k.style[l[0]] = l[1]), q.applyAnimationDelay && (y.animationDelay = Q, l = [ ra, Q + "s" ], 
                                m.push(l), k.style[l[0]] = l[1]);
                            }
                            if (F = 1e3 * H, G = 1e3 * J, c.easing) {
                                var r = c.easing;
                                q.hasTransitions && (l = O + "TimingFunction", m.push([ l, r ]), k.style[l] = r), 
                                q.hasAnimations && (l = V + "TimingFunction", m.push([ l, r ]), k.style[l] = r);
                            }
                            y.transitionDuration && p.push(pa), y.animationDuration && p.push(qa), x = Date.now(), 
                            a.on(p.join(" "), g), n(d, F + 1.5 * G), xa(a, c);
                        }
                    }
                    function d() {
                        h();
                    ...
                    if (!K) {
                        var x, p = [], l = function(a) {
                            if (C) D && a && (D = !1, h()); else if (D = !a, y.animationDuration) if (a = ma(k, D), 
                            D) m.push(a); else {
                                var b = m, c = b.indexOf(a);
                                a >= 0 && b.splice(c, 1);
                            }
                        }, r = U > 0 && (y.transitionDuration && 0 === T.transitionDuration || y.animationDuration && 0 === T.animationDuration) && Math.max(T.animationDelay, T.transitionDelay);
                        r ? n(b, Math.floor(r * U * 1e3), !1) : b(), t.resume = function() {
                            l(!0);
                        }, t.pause = function() {
                            l(!1);
                        };
                ...
                var k = A(a);
                c = ia(c);
                var K, D, C, p, t, H, F, J, G, m = [], r = a.attr("class"), v = Ea(c);
                ...
                c.removeClass && (N.length && (N += " "), N += ba(c.removeClass, "-remove")), c.applyClassesEarly && N.length && (B(a, c), 
                N = "");
                ...
                0 < c.stagger ? (v = parseFloat(c.stagger), T = {
                    ...
                    animationDuration: 0
                }) : ($ = z(k, fa), T = Z(k, Y, $, Na)), e.addClass(a, Y), c.transitionStyle && (v = [ O, c.transitionStyle ], 
                da(k, v), m.push(v)), 0 <= c.duration && (v = 0 < k.style[O].length, v = Aa(c.duration, v), 
                da(k, v), m.push(v)), c.keyframeStyle && (v = [ V, c.keyframeStyle ], da(k, v), 
                m.push(v));
                ...
                var q = {};
                return q.hasTransitions = 0 < y.transitionDuration, q.hasAnimations = 0 < y.animationDuration, 
                ...
                (q.applyTransitionDuration || q.applyAnimationDuration) && (J = c.duration ? parseFloat(c.duration) : J, 
                q.applyTransitionDuration && (q.hasTransitions = !0, y.transitionDuration = J, v = 0 < k.style[O + "Property"].length, 
                m.push(Aa(J, v))), q.applyAnimationDuration && (q.hasAnimations = !0, y.animationDuration = J, 
                m.push([ sa, J + "s" ]))), 0 !== J || q.recalculateTimingStyles ? (null == c.duration && 0 < y.transitionDuration && (q.recalculateTimingStyles = q.recalculateTimingStyles || aa), 
                F = 1e3 * H, G = 1e3 * J, c.skipBlocking || (q.blockTransition = 0 < y.transitionDuration, 
                q.blockKeyframeAnimation = 0 < y.animationDuration && 0 < T.animationDelay && 0 === T.animationDuration), 
                wa(a, c), q.blockTransition || ja(k, !1), L(J), {
                    $$willAnimate: !0,
                    end: d,
                    start: function() {
                        return K ? void 0 : (t = {
        ...
        a.drivers.push("$$animateCssDriver"), this.$get = [ "$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$document", "$sniffer", function(a, c, d, e, s, n) {
            ...
            function l(a, b) {
                return U(a) && (a = a.split(" ")), U(b) && (b = b.split(" ")), a.filter(function(a) {
            ...
            function D(c, e, z) {
                ...
                e.addClass("ng-animate-shim"), z.addClass("ng-animate-shim"), n.addClass("ng-anchor"), 
                w.append(n);
                var h;
                if (c = function() {
                    var c = a(n, {
                ...
                return {
                    start: function() {
                        ...
                        return c.done(function() {
                            return c = null, !h && (h = s()) ? (c = h.start(), c.done(function() {
                                c = null, f(), b.complete();
                            }), c) : (f(), void b.complete());
                        }), b = new d({
                            end: a,
            ...
            function z(a, b, c, e) {
                ...
                return u(e, function(a) {
                    ...
                    start: function() {
                        ...
                        var b = [];
                        g && b.push(g.start()), f && b.push(f.start()), u(l, function(a) {
                            b.push(a.start());
                        });
                        var c = new d({
                            end: a,
            ...
            function t(c) {
                ...
                return c.structural ? (e.structural = e.applyClassesEarly = !0, e.event = c.event, 
                "leave" === e.event && (e.onDone = e.domOperation)) : e.event = null, c = a(d, e), 
                c.$$willAnimate ? c : null;
            }
        ...
        this.$get = [ "$injector", "$$AnimateRunner", "$$rAFMutex", "$$jqLite", function(b, c, d, e) {
            ...
            return function(a, b, d, e) {
                ...
                function B(a, b, d, e, f) {
                    ...
                    if (0 === m.length) {
                        var g, l;
                        "beforeSetClass" === f ? (g = w(a, "removeClass", d, e, "beforeRemoveClass"), l = w(a, "addClass", d, e, "beforeAddClass")) : "setClass" === f && (g = w(a, "removeClass", d, e, "removeClass"), 
                        l = w(a, "addClass", d, e, "addClass")), g && (m = m.concat(g)), l && (m = m.concat(l));
                    }
                    return 0 !== m.length ? function(a) {
                        var b = [];
                        return m.length && u(m, function(a) {
                            b.push(a());
                ...
                3 === arguments.length && na(d) && (e = d, d = null), e = ia(e), d || (d = a.attr("class") || "", 
                e.addClass && (d += " " + e.addClass), e.removeClass && (d += " " + e.removeClass));
                var E, f, r = e.addClass, K = e.removeClass, C = s(d);
                if (C.length) {
                    var F, G;
                    "leave" == b ? (G = "leave", F = "afterLeave") : (G = "before" + b.charAt(0).toUpperCase() + b.substr(1), 
                    F = b), "enter" !== b && "move" !== b && (E = B(a, b, e, C, G)), f = B(a, b, e, C, F);
                }
                return E || f ? {
                    start: function() {
                        function b(c) {
        ...
        function dirPaginationCompileFn(tElement, tAttrs) {
            ...
            return paginationService.registerInstance(rawId), function(scope, element, attrs) {
                ...
                scope.$watch(function() {
                    ...
                    result >= 0 && paginationService.setCollectionLength(paginationId, result);
    ...
    function dirPaginationControlsDirective(paginationService, paginationTemplate) {
        function dirPaginationControlsLinkFn(scope, element, attrs) {
            ...
            scope.maxSize || (scope.maxSize = 9), scope.autoHide = void 0 === scope.autoHide ? !0 : scope.autoHide, 
            scope.directionLinks = angular.isDefined(attrs.directionLinks) ? scope.$parent.$eval(attrs.directionLinks) : !0, 
            scope.boundaryLinks = angular.isDefined(attrs.boundaryLinks) ? scope.$parent.$eval(attrs.boundaryLinks) : !1;
            ...
            scope.pages = [], scope.pagination = {
                ...
                return paginationService.isRegistered(paginationId) ? (paginationService.getCollectionLength(paginationId) + 1) * paginationService.getItemsPerPage(paginationId) : void 0;
            }, function(length) {
                length > 0 && generatePagination();
            }), scope.$watch(function() {
                return paginationService.isRegistered(paginationId) ? paginationService.getItemsPerPage(paginationId) : void 0;
            }, function(current, previous) {
                current != previous && "undefined" != typeof previous && goToPage(scope.pagination.current);
            }), scope.$watch(function() {
                return paginationService.isRegistered(paginationId) ? paginationService.getCurrentPage(paginationId) : void 0;
        ...
        function generatePagesArray(currentPage, collectionLength, rowsPerPage, paginationRange) {
            ...
            position = halfWay >= currentPage ? "start" : currentPage > totalPages - halfWay ? "end" : "middle";
            for (var ellipsesNeeded = totalPages > paginationRange, i = 1; totalPages >= i && paginationRange >= i; ) {
        ...
        function calculatePageNumber(i, currentPage, paginationRange, totalPages) {
            ...
            return i === paginationRange ? totalPages : 1 === i ? i : totalPages > paginationRange ? currentPage > totalPages - halfWay ? totalPages - paginationRange + i : currentPage > halfWay ? currentPage - halfWay + i : i : i;
        }
        var numberRegex = /^\d+$/;
        return {
            restrict: "AE",
...
function() {
    ...
    s = function(a) {
        ...
        return a.prototype.renderInside = function() {
            ...
            this.inside.innerHTML = "", g = this.options.theme, b = this.el.className.split(" "), 
            f = [], i = 0, k = b.length; k > i; i++) c = b[i], c.length && ((e = /^odometer-theme-(.+)$/.exec(c)) ? g = e[1] : /^odometer(-|$)/.test(c) || f.push(c));
            for (f.push("odometer"), p || f.push("odometer-no-transitions"), f.push(g ? "odometer-theme-" + g : "odometer-auto-theme"), 
            this.el.className = f.join(" "), this.ribbons = {}, this.digits = [], h = !this.format.precision || !t(a) || !1, 
            m = a.toString().split("").reverse(), j = 0, l = m.length; l > j; j++) d = m[j], 
            "." === d && (h = !0), this.addDigit(d, h);
...
!function(a, b) {
    ...
    function Sb(b, c, d, e) {
        ...
        g && P(b, "Date", O(b, "Date") + g * d), h && ia(b, O(b, "Month") + h * d), e && a.updateOffset(b, g || h));
    }
    function Tb(a, b) {
            ...
            function A() {
                ...
                return function(j) {
                    ...
                    n = N.scrollLeft()), !l || !(0 > k || 0 > m)) {
                        if (W) w("windowScrollDone" == j ? !0 : !1); else if ("windowScrollDone" == j) return null;
    ...
    return $.extend(proto, {
        ...
        link: function(scope, element, attr, ctrl) {
            ...
            function checkOptions(options) {
                return options = isObject(options) ? options : {}, options.disabled = options.source ? options.disabled : !0, 
            ...
            var status = !1, selectItem = null, events = {}, ngModel = null, each = angular.forEach, isObject = angular.isObject, extend = angular.extend, autocomplete = scope.$eval(attr.uiAutocomplete), valueMethod = angular.bind(element, element.val), methodsName = [ "close", "destroy", "disable", "enable", "instance", "option", "search", "widget" ], eventsName = [ "change", "close", "create", "focus", "open", "response", "search", "select" ], unregisterWatchModel = scope.$watch(attr.ngModel, function(value) {
                ...
                change: function(event, ui) {
                    ...
                    selectItem && selectItem.item && -1 !== value.indexOf(selectItem.item.value) && (value = selectItem.item.value, 
            ...
            link: function(scope, elm, attrs) {
                ...
                function outsideClickHandler(e) {
                    function isInPopover(el) {
                        ...
                        return parent ? parent.id === id ? !0 : isInPopover(parent) : !1;
                    }
                ...
                options.mouseRelative && (options.mouseRelativeX = -1 !== options.mouseRelative.indexOf("x"), 
                options.mouseRelativeY = -1 !== options.mouseRelative.indexOf("y"));
                var displayer_ = {
                    id_: undefined,
...
function(window, angular, undefined) {
    function $$CookieWriter($document, $log, $browser) {
        function buildCookieString(name, value, options) {
            ...
            value === undefined && (expires = "Thu, 01 Jan 1970 00:00:00 GMT", value = ""), 
