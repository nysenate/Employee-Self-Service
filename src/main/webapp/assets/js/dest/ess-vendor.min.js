...
!function(a, b) {
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            this._hoverable(this.buttonElement), this.buttonElement.addClass(i).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
                ...
                return !o.disabled && (e(this).addClass("ui-state-active"), t = this, void n.document.one("mouseup", function() {
                    t = null;
                }));
            }).bind("mouseup" + this.eventNamespace, function() {
                return !o.disabled && void e(this).removeClass("ui-state-active");
            }).bind("keydown" + this.eventNamespace, function(t) {
                return !o.disabled && void ((t.keyCode === e.ui.keyCode.SPACE || t.keyCode === e.ui.keyCode.ENTER) && e(this).addClass("ui-state-active"));
        ...
        _destroy: function() {
            this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(i + " ui-state-active " + n).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), 
            this.hasTitle || this.buttonElement.removeAttr("title");
        },
        _setOption: function(e, t) {
            return this._super(e, t), "disabled" === e ? (this.element.prop("disabled", !!t), 
    ...
    e.widget("ui.dialog", {
            ...
            this.uiDialog = e("<div>").addClass("ui-dialog ui-widget ui-widget-content ui-corner-all ui-front " + this.options.dialogClass).hide().attr({
                ...
                keydown: function(t) {
                    ...
                    if (t.keyCode === e.ui.keyCode.TAB) {
                        ...
                        t.preventDefault()) : (a.focus(1), t.preventDefault());
                    }
                },
        ...
        _makeResizable: function() {
            ...
            this.uiDialog.resizable({
                ...
                stop: function(s, n) {
                    a.height = e(this).height(), a.width = e(this).width(), e(this).removeClass("ui-dialog-resizing"), 
                    i._unblockFrames(), i._trigger("resizeStop", s, t(n));
                }
            }).css("position", n);
        },
        _minHeight: function() {
        ...
        _setOption: function(e, t) {
            ...
            "closeText" === e && this.uiDialogTitlebarClose.button({
                label: "" + t
            }), "draggable" === e && (i = s.is(":data(ui-draggable)"), i && !t && s.draggable("destroy"), 
            !i && t && this._makeDraggable()), "position" === e && this._position(), "resizable" === e && (a = s.is(":data(ui-resizable)"), 
            a && !t && s.resizable("destroy"), a && "string" == typeof t && s.resizable("option", "handles", t), 
            a || t === !1 || this._makeResizable()), "title" === e && this._title(this.uiDialogTitlebar.find(".ui-dialog-title")));
        },
        _size: function() {
            ...
            this.element.show().css({
                ...
                height: "auto",
                width: a.width
            }).outerHeight(), t = Math.max(0, a.minHeight - e), i = "number" == typeof a.maxHeight ? Math.max(0, a.maxHeight - e) : "none", 
        ...
        _position: function() {
            ...
            1 === a.length && (a[1] = a[0]), e.each([ "left", "top" ], function(e, t) {
            ...
            t = this.uiDialog.is(":visible"), t || this.uiDialog.show(), this.uiDialog.position(i), 
    ...
    e.extend(i.prototype, {
        ...
        _attachDatepicker: function(t, i) {
            var a, s, n;
            a = t.nodeName.toLowerCase(), s = "div" === a || "span" === a, t.id || (this.uuid += 1, 
            t.id = "dp" + this.uuid), n = this._newInst(e(t), s), n.settings = e.extend({}, i || {}), 
        ...
        _connectDatepicker: function(t, i) {
            var a = e(t);
            i.append = e([]), i.trigger = e([]), a.hasClass(this.markerClassName) || (this._attachments(a, i), 
        ...
        _attachments: function(t, i) {
            ...
            a = this._get(i, "showOn"), ("focus" === a || "both" === a) && t.focus(this._showDatepicker), 
            ("button" === a || "both" === a) && (s = this._get(i, "buttonText"), n = this._get(i, "buttonImage"), 
        ...
        _autoSize: function(e) {
            if (this._get(e, "autoSize") && !e.inline) {
                ...
                r.match(/[DM]/) && (t = function(e) {
                    for (i = 0, a = 0, s = 0; e.length > s; s++) e[s].length > i && (i = e[s].length, 
                    a = s);
                    return a;
        ...
        _inlineDatepicker: function(t, i) {
            ...
            e.data(t, r, i), this._setDate(i, this._getDefaultDate(i), !0), this._updateDatepicker(i), 
        ...
        _dialogDatepicker: function(t, i, a, n, o) {
            ...
            return p || (this.uuid += 1, u = "dp" + this.uuid, this._dialogInput = e("<input type='text' id='" + u + "' style='position: absolute; top: -100px; width: 0px;'/>"), 
            this._dialogInput.keydown(this._doKeyDown), e("body").append(this._dialogInput), 
            p = this._dialogInst = this._newInst(this._dialogInput, !1), p.settings = {}, e.data(this._dialogInput[0], r, p)), 
            s(p.settings, n || {}), i = i && i.constructor === Date ? this._formatDate(p, i) : i, 
            this._dialogInput.val(i), this._pos = o ? o.length ? o : [ o.pageX, o.pageY ] : null, 
            this._pos || (c = document.documentElement.clientWidth, h = document.documentElement.clientHeight, 
            ...
            this._pos = [ c / 2 - 100 + l, h / 2 - 150 + d ]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), 
            p.settings.onSelect = a, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), 
        ...
        _destroyDatepicker: function(t) {
            ...
            "input" === i ? (s.append.remove(), s.trigger.remove(), a.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp)) : ("div" === i || "span" === i) && a.removeClass(this.markerClassName).empty());
        },
        _enableDatepicker: function(t) {
            var i, a, s = e(t), n = e.data(t, r);
            s.hasClass(this.markerClassName) && (i = t.nodeName.toLowerCase(), "input" === i ? (t.disabled = !1, 
        ...
        _disableDatepicker: function(t) {
            var i, a, s = e(t), n = e.data(t, r);
            s.hasClass(this.markerClassName) && (i = t.nodeName.toLowerCase(), "input" === i ? (t.disabled = !0, 
            n.trigger.filter("button").each(function() {
                this.disabled = !0;
            }).end().filter("img").css({
                opacity: "0.5",
        ...
        _optionDatepicker: function(i, a, n) {
            ...
            "string" == typeof a && (r = {}, r[a] = n), h && (this._curInst === h && this._hideDatepicker(), 
            o = this._getDateDatepicker(i, !0), u = this._getMinMaxDate(h, "min"), c = this._getMinMaxDate(h, "max"), 
            s(h.settings, r), null !== u && r.dateFormat !== t && r.minDate === t && (h.settings.minDate = this._formatDate(h, u)), 
            ...
            this._attachments(e(i), h), this._autoSize(h), this._setDate(h, o), this._updateAlternate(h), 
            this._updateDatepicker(h)), t);
        },
        ...
        _showDatepicker: function(t) {
            ...
            !e.datepicker._isDisabledDatepicker(t) && e.datepicker._lastInput !== t) {
                ...
                a = e.datepicker._get(i, "beforeShow"), n = a ? a.apply(t, [ t, i ]) : {}, n !== !1 && (s(i.settings, n), 
                ...
                e.datepicker._pos[1] += t.offsetHeight), r = !1, e(t).parents().each(function() {
                    ...
                    left: o.left + "px",
                    top: o.top + "px"
                }), i.inline || (u = e.datepicker._get(i, "showAnim"), c = e.datepicker._get(i, "duration"), 
                i.dpDiv.zIndex(e(t).zIndex() + 1), e.datepicker._datepickerShowing = !0, e.effects && e.effects.effect[u] ? i.dpDiv.show(u, e.datepicker._get(i, "showOptions"), c) : i.dpDiv[u || "show"](u ? c : null), 
        ...
        _checkOffset: function(t, i, a) {
            ...
            i.top -= Math.min(i.top, i.top + n > c && c > n ? Math.abs(n + o) : 0), i;
        },
        _findPos: function(t) {
        ...
        _selectDay: function(t, i, a, s) {
            ...
            n.selectedDay = n.currentDay = e("a", s).html(), n.selectedMonth = n.currentMonth = i, 
            n.selectedYear = n.currentYear = a, this._selectDate(t, this._formatDate(n, n.currentDay, n.currentMonth, n.currentYear)));
        },
        ...
        _selectDate: function(t, i) {
            ...
            a = this._get(n, "onSelect"), a ? a.apply(n.input ? n.input[0] : null, [ i, n ]) : n.input && n.input.trigger("change"), 
        ...
        _updateAlternate: function(t) {
            ...
            n && (i = this._get(t, "altFormat") || this._get(t, "dateFormat"), a = this._getDate(t), 
            s = this.formatDate(i, a, this._getFormatConfig(t)), e(n).each(function() {
                e(this).val(s);
            }));
        },
        ...
        parseDate: function(i, a, s) {
            ...
            var n, r, o, u, c = 0, h = (s ? s.shortYearCutoff : null) || this._defaults.shortYearCutoff, l = "string" != typeof h ? h : new Date().getFullYear() % 100 + parseInt(h, 10), d = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort, p = (s ? s.dayNames : null) || this._defaults.dayNames, g = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort, m = (s ? s.monthNames : null) || this._defaults.monthNames, f = -1, _ = -1, v = -1, k = -1, y = !1, b = function(e) {
                ...
                if (e.each(o, function(e, i) {
                    var s = i[1];
                    return a.substr(c, s.length).toLowerCase() === s.toLowerCase() ? (r = i[0], c += s.length, 
                    !1) : t;
                }), -1 !== r) return r + 1;
            ...
            for (n = 0; i.length > n; n++) if (y) "'" !== i.charAt(n) || b("'") ? M() : y = !1; else switch (i.charAt(n)) {
              ...
              case "!":
                u = new Date((D("!") - this._ticksTo1970) / 1e4), f = u.getFullYear(), _ = u.getMonth() + 1, 
                v = u.getDate();
                break;
            ...
            k > -1) for (_ = 1, v = k; r = this._getDaysInMonth(f, _ - 1), !(r >= v); ) _++, 
            v -= r;
        ...
        _setDateFromField: function(e, t) {
            if (e.input.val() !== e.lastVal) {
                ...
                e.currentDay = a ? n.getDate() : 0, e.currentMonth = a ? n.getMonth() : 0, e.currentYear = a ? n.getFullYear() : 0, 
        ...
        _determineDate: function(t, i, a) {
            ...
            return r = r && "Invalid Date" == "" + r ? a : r, r && (r.setHours(0), r.setMinutes(0), 
        ...
        _setDate: function(e, t, i) {
            ...
            e.drawYear = e.selectedYear = e.currentYear = r.getFullYear(), s === e.selectedMonth && n === e.selectedYear || i || this._notifyChange(e), 
        ...
        _generateHTML: function(e) {
            ...
            if (0 > Z && (Z += 12, et--), X) for (t = this._daylightSavingAdjust(new Date(X.getFullYear(), X.getMonth() - q[0] * q[1] + 1, X.getDate())), 
            t = $ && $ > t ? $ : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t; ) Z--, 
            0 > Z && (Z = 11, et--);
            for (e.drawMonth = Z, e.drawYear = et, i = this._get(e, "prevText"), i = z ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - J, 1)), this._getFormatConfig(e)) : i, 
            ...
            s = this._get(e, "nextText"), s = z ? this.formatDate(s, this._daylightSavingAdjust(new Date(et, Z + J, 1)), this._getFormatConfig(e)) : s, 
            ...
            r = this._get(e, "currentText"), o = this._get(e, "gotoCurrent") && e.currentDay ? V : W, 
            r = z ? this.formatDate(r, o, this._getFormatConfig(e)) : r, u = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", 
            ...
            h = parseInt(this._get(e, "firstDay"), 10), h = isNaN(h) ? 0 : h, l = this._get(e, "showWeek"), 
            d = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), g = this._get(e, "monthNames"), 
            m = this._get(e, "monthNamesShort"), f = this._get(e, "beforeShowDay"), _ = this._get(e, "showOtherMonths"), 
            v = this._get(e, "selectOtherMonths"), k = this._getDefaultDate(e), y = "", D = 0; q[0] > D; D++) {
                for (w = "", this.maxRows = 4, M = 0; q[1] > M; M++) {
                    if (C = this._daylightSavingAdjust(new Date(et, Z, e.selectedDay)), x = " ui-corner-all", 
                    I = "", Q) {
                    ...
                    b = 0; 7 > b; b++) T = (b + h) % 7, N += "<th" + ((b + h + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[T] + "'>" + p[T] + "</span></th>";
                    for (I += N + "</tr></thead><tbody>", A = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), 
                    E = (this._getFirstDayOfMonth(et, Z) - h + 7) % 7, S = Math.ceil((E + A) / 7), Y = Q && this.maxRows > S ? this.maxRows : S, 
                    this.maxRows = Y, F = this._daylightSavingAdjust(new Date(et, Z, 1 - E)), P = 0; Y > P; P++) {
                        for (I += "<tr>", O = l ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(F) + "</td>" : "", 
                        b = 0; 7 > b; b++) j = f ? f.apply(e.input ? e.input[0] : null, [ F ]) : [ !0, "" ], 
                    ...
                    Z++, Z > 11 && (Z = 0, et++), I += "</tbody></table>" + (Q ? "</div>" + (q[0] > 0 && M === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), 
                    w += I;
                }
                y += w;
            }
        ...
        _generateMonthYearHeader: function(e, t, i, a, s, n, r, o) {
            ...
            if (n || !f) y += "<span class='ui-datepicker-month'>" + r[t] + "</span>"; else {
                for (u = a && a.getFullYear() === i, c = s && s.getFullYear() === i, y += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", 
                h = 0; 12 > h; h++) (!u || h >= a.getMonth()) && (!c || s.getMonth() >= h) && (y += "<option value='" + h + "'" + (h === t ? " selected='selected'" : "") + ">" + o[h] + "</option>");
                y += "</select>";
            }
            if (v || (k += y + (!n && f && _ ? "" : "&#xa0;")), !e.yearshtml) if (e.yearshtml = "", 
            n || !_) k += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
                for (l = this._get(e, "yearRange").split(":"), d = new Date().getFullYear(), p = function(e) {
                    var t = e.match(/c[+\-].*/) ? i + parseInt(e.substring(1), 10) : e.match(/[+\-].*/) ? d + parseInt(e, 10) : parseInt(e, 10);
                    return isNaN(t) ? d : t;
                }, g = p(l[0]), m = Math.max(g, p(l[1] || "")), g = a ? Math.max(g, a.getFullYear()) : g, 
                m = s ? Math.min(m, s.getFullYear()) : m, e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; m >= g; g++) e.yearshtml += "<option value='" + g + "'" + (g === i ? " selected='selected'" : "") + ">" + g + "</option>";
                e.yearshtml += "</select>", k += e.yearshtml, e.yearshtml = null;
            }
            return k += this._get(e, "yearSuffix"), v && (k += (!n && f && _ ? "" : "&#xa0;") + y), 
            k += "</div>";
        },
        ...
        _isInRange: function(e, t) {
            ...
            return u && (i = u.split(":"), a = new Date().getFullYear(), r = parseInt(i[0], 10), 
            o = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (r += a), i[1].match(/[+\-].*/) && (o += a)), 
    ...
    t.widget("ui.menu", {
        ...
        _keydown: function(e) {
            ...
            switch (e.keyCode) {
              ...
              default:
                ...
                clearTimeout(this.filterTimer), a === n ? o = !0 : a = n + a, r = RegExp("^" + i(a), "i"), 
        ...
        _scrollIntoView: function(e) {
            ...
            a = this.activeMenu.scrollTop(), o = this.activeMenu.height(), r = e.height(), 0 > n ? this.activeMenu.scrollTop(a + n) : n + r > o && this.activeMenu.scrollTop(a + n - o + r));
        },
        blur: function(t, e) {
    ...
    function N(a) {
        return function() {
            var d, b = arguments[0];
            for (d = "[" + (a ? a + ":" : "") + b + "] http://errors.angularjs.org/1.5.8/" + (a ? a + "/" : "") + b, 
    ...
    function pa(a, b) {
        ...
        function c(a) {
            ...
            var b = !1, c = e(a);
            return void 0 === c && (c = L(a) ? [] : Object.create(wc(a)), b = !0), f.push(a), 
            g.push(c), b ? d(a, c) : c;
        }
        function e(a) {
            switch (ma.call(a)) {
    ...
    function ce(a, b) {
        var d = b;
        return "string" == typeof a && "$" === a.charAt(0) && "$" === a.charAt(1) ? d = void 0 : Va(b) ? d = "$WINDOW" : b && C.document === b ? d = "$DOCUMENT" : Ya(b) && (d = "$SCOPE"), 
        d;
    }
    function bb(a, b) {
    ...
    function Sb(a, b, d) {
        ...
        return b = yc(b, c), d *= b - c, a = new Date(a.getTime()), a.setMinutes(a.getMinutes() + d), 
        a;
    }
    function ya(a) {
        a = F(a).clone();
    ...
    function Ac(a) {
        ...
        return q((a || "").split("&"), function(a) {
            ...
            f = a.substring(c + 1)), e = zc(e), w(e) && (f = !w(f) || zc(f), ua.call(b, e) ? L(b[e]) ? b[e].push(f) : b[e] = [ b[e], f ] : b[e] = f));
        }), b;
    }
    function Tb(a) {
        var b = [];
    ...
    function Bc(a, b, d) {
        ...
        return C && e.test(C.name) && (d.debugInfoEnabled = !0, C.name = C.name.replace(e, "")), 
        C && !f.test(C.name) ? c() : (C.name = C.name.replace(f, ""), ca.resumeBootstrap = function(a) {
    ...
    function he(a) {
        if (a = ca.element(a).injector(), !a) throw xa("test");
    ...
    function Pa(a, b, d) {
        return d && L(a) && (a = a[a.length - 1]), sb(z(a), b, "not a function, got " + (a && "object" == typeof a ? a.constructor.name || "Object" : typeof a)), 
        a;
    }
    function Qa(a, b) {
    ...
    function tb(a) {
        for (var c, b = a[0], d = a[a.length - 1], e = 1; b !== d && (b = b.nextSibling); e++) (c || a[e] !== b) && (c || (c = F(va.call(a, 0, e))), 
        c.push(b));
        return c || a;
    }
    function U() {
    ...
    function le(a) {
        S(a, {
            ...
            a.provider({
                ...
                ngInclude: We
            }).directive(vb).directive(Lc), a.provider({
                $anchorScroll: Xe,
                $animate: Ye,
                $animateCss: Ze,
                $$animateJs: $e,
    ...
    function Oc(a, b) {
        ...
        if (Vb.test(a)) {
            for (d = e.appendChild(b.createElement("div")), c = (Mf.exec(a) || [ "", "" ])[1].toLowerCase(), 
            c = ja[c] || ja._default, d.innerHTML = c[1] + a.replace(Nf, "<$1></$2>") + c[2], 
    ...
    function Rc(a, b, d, c) {
        ...
        if (f) if (b) {
            var g = function(b) {
                var c = e[b];
                w(d) && Za(c || [], d), w(d) && c && 0 < c.length || (a.removeEventListener(b, f, !1), 
                delete e[b]);
            };
    ...
    function eb(a, b) {
        ...
        Rc(a)), delete fb[d], a.ng339 = void 0));
    }
    function xb(a, b) {
        var d = a.ng339, d = d && fb[d];
        return b && !d && (a.ng339 = d = ++Pf, d = fb[d] = {
            events: {},
            data: {},
            handle: void 0
        }), d;
    ...
    function cb(a, b) {
        function d(a) {
            return function(b, c) {
                return D(b) ? void q(b, uc(a)) : a(b, c);
            };
        }
        function c(a, b) {
        ...
        function g(a) {
            ...
            return q(a, function(a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        G(a) ? (c = Ub(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), 
        ...
        function h(a, c) {
            ...
            return {
                invoke: function(a, b, c, d) {
                    return "string" == typeof c && (d = c, c = null), c = e(a, c, d), L(a) && (a = a[a.length - 1]), 
                    d = !(11 >= Ea) && ("function" == typeof a && /^(?:class\b|constructor\()/.test(Function.prototype.toString.call(a) + " ")), 
                    d ? (c.unshift(null), new (Function.prototype.bind.apply(a, c))()) : a.apply(b, c);
                },
        ...
        this.disableAutoScrolling = function() {
            ...
            function f(a) {
                if (a) {
                    a.scrollIntoView();
                    var c;
                    c = g.yOffset, z(c) ? c = c() : Qb(c) ? (c = c[0], c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : T(c) || (c = 0), 
    ...
    function $f(a, b, d, c) {
        ...
        g(), J = r, k.url = function(b, d, e) {
            if (y(e) && (e = null), l !== a.location && (l = a.location), m !== a.history && (m = a.history), 
            b) {
                var f = J === e;
                if (v === b && (!c.history || f)) return k;
                var h = v && Ja(v) === Ja(b);
                return v = b, J = e, !c.history || h && f ? (h || (t = b), d ? l.replace(b) : h ? (d = l, 
                e = b.indexOf("#"), e = -1 === e ? "" : b.substr(e), d.hash = e) : l.href = b, l.href !== b && (t = b)) : (m[d ? "replaceState" : "pushState"](e, "", b), 
                g(), J = r), t && (t = b), k;
            }
        ...
        k.onUrlChange = function(b) {
            return H || (c.history && F(a).on("popstate", f), F(a).on("hashchange", f), H = !0), 
            M.push(b), b;
    ...
    function ef() {
        this.$get = function() {
            function a(a, c) {
                ...
                var g = 0, h = S({}, c, {
                    id: a
                }), k = U(), l = c && c.capacity || Number.MAX_VALUE, m = U(), n = null, p = null;
                return b[a] = {
                    put: function(a, b) {
                        if (!y(b)) {
    ...
    function Fc(a, b) {
        ...
        this.directive = function B(b, d) {
            return Qa(b, "directive"), G(b) ? (c(b), sb(d, "directiveFactory"), f.hasOwnProperty(b) || (f[b] = [], 
            a.factory(b + "Directive", [ "$injector", "$exceptionHandler", function(a, c) {
                ...
                return q(f[b], function(f, g) {
                    try {
                        ...
                        z(h) ? h = {
                            compile: ha(h)
                        } : !h.compile && h.link && (h.compile = ha(h.link)), h.priority = h.priority || 0, 
                        h.index = g, h.name = h.name || b, h.require = e(h), h.restrict = h.restrict || "EA", 
                        h.$$moduleName = f.$$moduleName, d.push(h);
                    } catch (k) {
                        c(k);
                    }
                }), d;
        ...
        this.onChangesTtl = function(a) {
            ...
            function aa(a, b, c, d, e) {
                ...
                return function(b, c, d) {
                    ...
                    if (d = d.futureParentElement, f && f.$$boundTransclude && (f = f.$$boundTransclude), 
                    m || (m = (d = d && d[0]) && "foreignobject" !== wa(d) && ma.call(d).match(/SVG/) ? "svg" : "html"), 
            ...
            function s(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (m = 0, p = h.length; m < p; ) k = v[h[m++]], c = h[m++], f = h[m++], c ? (c.scope ? (l = a.$new(), 
                    aa.$$addScopeInfo(F(k), l)) : l = a, r = c.transcludeOnThisElement ? za(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? za(a, b) : null, 
                    c(f, l, k, d, r)) : f && f(a, k.childNodes, void 0, e);
                }
                for (var k, l, m, p, n, h = [], r = 0; r < a.length; r++) k = new Da(), l = $b(a[r], [], k, 0 === r ? d : void 0, e), 
                ...
                (f || k) && (h.push(r, f, k), p = !0, n = n || f), f = null;
                return p ? g : null;
            }
            function za(a, b, c) {
                  ...
                  case 1:
                    ...
                    for (var g, k, l, m, p = a.attributes, n = 0, r = p && p.length; n < r; n++) {
                        ...
                        g = p[n], k = g.name, l = W(g.value), g = Aa(k), (m = Ba.test(g)) && (k = k.replace(Yc, "").substr(8).replace(/_(.)/g, function(a, b) {
                            return b.toUpperCase();
                        })), (g = g.match(Ca)) && V(g[1]) && (v = k, u = k.substr(0, k.length - 5) + "end", 
                        k = k.substr(0, k.length - 6)), g = Aa(k.toLowerCase()), f[g] = k, !m && c.hasOwnProperty(g) || (c[g] = l, 
                        Uc(a, g) && (c[g] = !0)), ia(a, b, l, g, m), O(b, g, "A", d, e, v, u);
                    }
                    if (f = a.className, D(f) && (f = f.animVal), G(f) && "" !== f) for (;a = h.exec(f); ) g = Aa(a[2]), 
                    O(b, g, "C", d, e) && (c[g] = W(a[3])), f = f.substr(a.index + a[0].length);
                    break;

                  case Ma:
                    if (11 === Ea) for (;a.parentNode && a.nextSibling && a.nextSibling.nodeType === Ma; ) a.nodeValue += a.nextSibling.nodeValue, 
            ...
            function oa(a, b, d, e, f, g, h, k, l) {
                function m(a, b, c, d) {
                    a && (c && (a = Zc(a, c, d)), a.require = x.require, a.directiveName = I, (u === x || x.$$isolateScope) && (a = ja(a, {
                        isolateScope: !0
                    })), h.push(a)), b && (c && (b = Zc(b, c, d)), b.require = x.require, b.directiveName = I, 
                    (u === x || x.$$isolateScope) && (b = ja(b, {
                        isolateScope: !0
                    })), k.push(b));
                }
                function p(a, e, f, g, l) {
                    function m(a, b, c, d) {
                        var e;
                        if (Ya(a) || (d = c, c = b, b = a, a = void 0), fa && (e = t), c || (c = fa ? I.parent() : I), 
                        !d) return l(a, b, e, c, s);
                        var f = l.$$slots[d];
                        if (f) return f(a, b, e, c, s);
                        if (y(f)) throw ga("noslot", d, ya(I));
                    }
                    var n, E, x, M, B, t, P, I;
                    b === f ? (g = d, I = d.$$element) : (I = F(f), g = new Da(I, d)), B = e, u ? M = e.$new(!0) : r && (B = e.$parent), 
                    l && (P = m, P.$$boundTransclude = l, P.isSlotFilled = function(a) {
                        return !!l.$$slots[a];
                    }), v && (t = ag(I, g, P, v, M, e, u)), u && (aa.$$addScopeInfo(I, M, !0, !(H && (H === u || H === u.$$originalDirective))), 
                    aa.$$addScopeClass(I, !0), M.$$isolateBindings = u.$$isolateBindings, E = ka(e, g, M, M.$$isolateBindings, u), 
                    ...
                    for (n in t) {
                        ...
                        var K = x();
                        K !== x.instance && (x.instance = K, I.data("$" + E.name + "Controller", K), x.bindingInfo.removeWatches && x.bindingInfo.removeWatches(), 
                    ...
                    var s = e;
                    for (u && (u.template || null === u.templateUrl) && (s = M), a && a(s, f.childNodes, void 0, l), 
                    n = k.length - 1; 0 <= n; n--) x = k[n], la(x, x.isolateScope ? M : e, I, g, x.require && ib(x.directiveName, x.require, I, t), P);
                    q(t, function(a) {
                ...
                for (var x, I, P, s, w, n = -Number.MAX_VALUE, r = l.newScopeDirective, v = l.controllerDirectives, u = l.newIsolateScopeDirective, H = l.templateDirective, E = l.nonTlbTranscludeDirective, M = !1, B = !1, fa = l.hasElementTranscludeDirective, t = d.$$element = F(b), K = e, Fa = !1, za = !1, A = 0, C = a.length; A < C; A++) {
                    ...
                    if ((w = x.scope) && (x.templateUrl || (D(w) ? (X("new/isolated scope", u || r, x, t), 
                    u = x) : X("new/isolated scope", u, x, t)), r = r || x), I = x.name, !Fa && (x.replace && (x.templateUrl || x.template) || x.transclude && !x.$$tlb)) {
                    ...
                    if (!x.templateUrl && x.controller && (w = x.controller, v = v || U(), X("'" + I + "' controller", v[I], x, t), 
                    v[I] = x), w = x.transclude) if (M = !0, x.$$tlb || (X("transclusion", E, x, t), 
                    E = x), "element" == w) fa = !0, n = x.priority, P = t, t = d.$$element = F(aa.$$createComment(I, d[I])), 
                    b = t[0], ea(f, va.call(P, 0), b), P[0].$$parentNode = P[0].parentNode, K = ac(za, P, e, n, g && g.name, {
                        ...
                        t.empty(), K = ac(za, P, e, void 0, void 0, {
                    ...
                    if (x.templateUrl) B = !0, X("template", H, x, t), H = x, x.replace && (g = x), 
                ...
                return p.scope = r && !0 === r.scope, p.transcludeOnThisElement = M, p.templateOnThisElement = B, 
                p.transclude = K, l.hasElementTranscludeDirective = fa, p;
            }
            function ib(a, b, c, d) {
                var e;
                if (G(b)) {
                ...
                } else if (L(b)) for (e = [], g = 0, f = b.length; g < f; g++) e[g] = ib(a, b[g], c, d); else D(b) && (e = {}, 
                q(b, function(b, f) {
                    e[f] = ib(a, b, c, d);
                }));
                return e || null;
                    ...
                    for (var n = 0, r = e.length; n < r; n++) try {
                        if (p = e[n], (y(h) || h > p.priority) && -1 != p.restrict.indexOf(g)) {
                            if (l && (p = Rb(p, {
                                ...
                                var u = p, v = p, x = p.name, H = {
                                    isolateScope: null,
                                    bindToController: null
                                };
                                if (D(v.scope) && (!0 === v.bindToController ? (H.bindToController = d(v.scope, x, !0), 
                                H.isolateScope = {}) : H.isolateScope = d(v.scope, x, !1)), D(v.bindToController) && (H.bindToController = d(v.bindToController, x, !0)), 
                                D(H.bindToController)) {
            ...
            function ba(a, b, c, d, f, g, h, k) {
                var m, p, l = [], n = b[0], r = a.shift(), u = Rb(r, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: r
                ...
                return b.empty(), e(H).then(function(e) {
                    ...
                    a = e, b.$$destroyed || (l ? l.push(b, c, d, a) : (m.transcludeOnThisElement && (a = za(b, m.transclude, e)), 
                    m(p, b, c, d, a)));
                };
            }
            function Z(a, b) {
                        ...
                        compile: function() {
                            return {
                                pre: function(a, c, k) {
                                    ...
                                    var l = k[e];
                                    l !== d && (h = l && b(l, !0, g, f), d = l), h && (k[e] = h(a), (c[e] || (c[e] = [])).$$inter = !0, 
            ...
            function ea(a, b, c) {
                ...
                for (F.hasData(d) && (F.data(c, F.data(d)), F(d).off("$destroy")), F.cleanData(a.querySelectorAll("*")), 
            ...
            function ka(a, c, d, e, f) {
                function g(b, c, e) {
                    z(d.$onChanges) && c !== e && (Y || (a.$$postDigest(I), Y = []), m || (m = {}, Y.push(h)), 
                    m[b] && (e = m[b].previousValue), m[b] = new Fb(e, c));
                }
                function h() {
                ...
                return q(e, function(e, h) {
                    ...
                    switch (e.mode) {
                      case "@":
                        ...
                        }), c.$$observers[m].$$scope = a, v = c[m], G(v) ? d[h] = b(v)(a) : Ga(v) && (d[h] = v), 
                        l[h] = new Fb(bc, d[h]);
                        break;
                      ...
                      case "=":
                        ...
                        }, p.$stateful = !0, p = e.collection ? a.$watchCollection(c[m], p) : a.$watch(n(c[m], p), null, u.literal), 
                        k.push(p);
                        break;
                      ...
                      case "&":
                        if (u = c.hasOwnProperty(m) ? n(c[m]) : A, u === A && p) break;
                        d[h] = function(b) {
                            return u(a, b);
                        };
                    }
            ...
            Da.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    f = wa(this.$$element), "a" === f && ("href" === a || "xlinkHref" === a) || "img" === f && "src" === a) this[a] = b = E(b, "src" === a); else if ("img" === f && "srcset" === a && w(b)) {
                        ...
                        g = W(g[2 * l]).split(/\s/), f += E(W(g[0]), !0), 2 === g.length && (f += " " + W(g[1])), 
                        this[a] = b = f;
                    }
        ...
        this.has = function(b) {
            ...
            return function(f, g, h, k) {
                ...
                if (h = !0 === h, k && G(k) && (n = k), G(f)) {
                    if (k = f.match(cd), !k) throw cg("ctrlfmt", f);
                    m = k[1], n = n || k[3], f = a.hasOwnProperty(m) ? a[m] : Ec(g.$scope, m, !0) || (b ? Ec(c, m, !0) : void 0), 
                    Pa(f, m, !0);
                }
                return h ? (h = (L(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), 
                n && e(g, n, l, m || f.name), S(function() {
                    ...
                    instance: l,
                    identifier: n
                })) : (l = d.instantiate(f, g, m), n && e(g, n, l, m || f.name), l);
            };
        } ];
    }
    function gf() {
    ...
    function mf() {
        ...
        this.$get = [ "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, k, l) {
            function m(b) {
                ...
                function f(a) {
                    var b = S({}, a);
                    return b.data = gd(a.data, a.headers, a.status, g.transformResponse), a = a.status, 
                    200 <= a && 300 > a ? b : k.reject(b);
                }
            ...
            function n(c, d) {
                ...
                function l(a, c, d, e) {
                    ...
                    E && (200 <= a && 300 > a ? E.put(P, [ a, c, ed(d), e ]) : E.remove(P)), b ? h.$applyAsync(f) : (f(), 
                    h.$$phase || h.$apply());
                }
                function n(a, b, d, e) {
                ...
                return m.pendingRequests.push(c), H.then(R, R), !c.cache && !a.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (E = D(c.cache) ? c.cache : D(a.cache) ? a.cache : u), 
    ...
    function gg(a, b, d, c, e) {
        function f(a, b, d) {
            ...
            return f.type = "text/javascript", f.src = a, f.async = !0, m = function(a) {
                ...
                a && ("load" !== a.type || c.wasCalled(b) || (a = {
                    type: "error"
                }), u = a.type, g = "error" === a.type ? 404 : 200), d && d(g, u);
        ...
        return function(e, h, k, l, m, n, p, u, R, B) {
            ...
            if (a.$$incOutstandingRequestCount(), h = h || a.url(), "jsonp" === Q(e)) var v = c.createCallback(h), fa = f(h, v, function(a, b) {
        ...
        this.startSymbol = function(b) {
            ...
            function k(f, k, p, n) {
                ...
                if (!f.length || -1 === f.indexOf(a)) {
                    var v;
                    return k || (k = g(f), v = ha(k), v.exp = f, v.expressions = [], v.$$watchDelegate = h), 
                    v;
                }
                n = !!n;
                var q, t, K = 0, M = [], H = [];
                ...
                for (var E = [], I = []; K < v; ) {
                    ...
                    K !== q && E.push(g(f.substring(K, q))), K = f.substring(q + l, t), M.push(K), H.push(d(K, J)), 
                    K = t + m, I.push(E.length), E.push("");
                }
        ...
        this.$get = [ "$rootScope", "$window", "$q", "$$q", "$browser", function(a, b, d, c, e) {
            function f(f, k, l, m) {
                ...
                return l = w(l) ? l : 0, fa.$$intervalId = R(function() {
                    J ? e.defer(n) : a.$evalAsync(n), v.notify(r++), 0 < l && r >= l && (v.resolve(r), 
                    q(fa.$$intervalId), delete g[fa.$$intervalId]), J || a.$apply();
                }, k), g[fa.$$intervalId] = v, fa;
            }
            var g = {};
            return f.cancel = function(a) {
                return !!(a && a.$$intervalId in g) && (g[a.$$intervalId].reject("canceled"), b.clearInterval(a.$$intervalId), 
                delete g[a.$$intervalId], !0);
            }, f;
        } ];
    }
    function fc(a) {
    ...
    function kd(a, b) {
        ...
        b.$$search = Ac(c.search), b.$$hash = decodeURIComponent(c.hash), b.$$path && "/" != b.$$path.charAt(0) && (b.$$path = "/" + b.$$path);
    }
    function ka(a, b) {
    ...
    function gc(a, b, d) {
        this.$$html5 = !0, d = d || "", jd(a, this), this.$$parse = function(a) {
            ...
            var f, g;
            return w(f = ka(a, c)) ? (g = f, g = w(f = ka(d, f)) ? b + (ka("/", f) || f) : a + g) : w(f = ka(b, c)) ? g = b + f : b == c + "/" && (g = b), 
            g && this.$$parse(g), !!g;
        };
    }
    function hc(a, b, d) {
        jd(a, this), this.$$parse = function(c) {
            ...
            y(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "", y(e) && (a = c, this.replace())) : (f = ka(d, e), 
            y(f) && (f = e)), kd(f, this), c = this.$$path;
            var e = a, g = /^\/[A-Z]:(\/.*)/;
            0 === f.lastIndexOf(e, 0) && (f = f.replace(e, "")), g.exec(f) || (c = (f = g.exec(c)) ? f[1] : c), 
    ...
    function ld(a, b, d) {
        this.$$html5 = !0, hc.apply(this, arguments), this.$$parseLinkUrl = function(c, e) {
            if (e && "#" === e[0]) return this.hash(e.slice(1)), !0;
            var f, g;
            return a == Ja(c) ? f = c : (g = ka(b, c)) ? f = a + d + g : b === c + "/" && (f = b), 
            f && this.$$parse(f), !!f;
        }, this.$$compose = function() {
            var b = Tb(this.$$search), e = this.$$hash ? "#" + qb(this.$$hash) : "";
    ...
    function sf() {
        ...
        this.hashPrefix = function(b) {
            ...
            Ga(a.requireBase) && (b.requireBase = a.requireBase), Ga(a.rewriteLinks) && (b.rewriteLinks = a.rewriteLinks), 
            this) : b;
            ...
            return c.onUrlChange(function(a, b) {
                y(ka(u, a)) ? g.location.href = a : (d.$evalAsync(function() {
                    ...
                    a = jb(a), l.$$parse(a), l.$$state = b, f = d.$broadcast("$locationChangeStart", a, c, b, e).defaultPrevented, 
    ...
    function uf() {
        ...
        this.addLiteral = function(a, b) {
                ...
                switch (e = e || J, typeof c) {
                  case "string":
                    ...
                    if (g = E[H], !g) {
                        ...
                        var q = new jc(g);
                        g = new kc(q, f, g).parse(c), g.constant ? g.$$watchDelegate = p : k ? g.$$watchDelegate = g.literal ? n : m : g.inputs && (g.$$watchDelegate = l), 
                        e && (g = h(g)), E[H] = g;
                    }
                    return u(g, d);
            ...
            function h(a) {
                ...
                if (!a) return a;
                b.$$watchDelegate = a.$$watchDelegate, b.assign = h(a.assign), b.constant = a.constant, 
                b.literal = a.literal;
                for (var c = 0; a.inputs && c < a.inputs.length; ++c) a.inputs[c] = h(a.inputs[c]);
                return b.inputs = a.inputs, b;
            }
            function k(a, b) {
                return null == a || null == b ? a === b : ("object" != typeof a || (a = ic(a), "object" != typeof a)) && (a === b || a !== a && b !== b);
            }
    ...
    function vd(a, b) {
        ...
        var g = N("$q", TypeError), h = function() {
            var a = new f();
            return a.resolve = c(a, a.resolve), a.reject = c(a, a.reject), a.notify = c(a, a.notify), 
            a;
        };
        S(d.prototype, {
            then: function(a, b, c) {
                ...
                0 < this.$$state.status && e(this.$$state), d.promise;
            },
            catch: function(a) {
            ...
            $$resolve: function(a) {
                ...
                var g, h = this, k = !1;
                try {
                    (D(a) || z(a)) && (g = a && a.then), z(g) ? (this.promise.$$state.status = -1, g.call(a, d, f, c(this, this.notify))) : (this.promise.$$state.value = a, 
    ...
    function vf() {
        function a(a) {
            function b() {
                ...
                this.$$listeners = {}, this.$$listenerCount = {}, this.$$watchersCount = 0, this.$id = ++pb, 
        ...
        this.digestTtl = function(a) {
            ...
            function m() {
                this.$id = ++pb, this.$$phase = this.$parent = this.$$watchers = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = null, 
            ...
            m.prototype = {
                ...
                $new: function(b, c) {
                    ...
                    c.$$childTail = d) : c.$$childHead = c.$$childTail = d, (b || c != this) && d.$on("$destroy", k), 
                    d;
                },
                $watch: function(a, b, d, e) {
                    ...
                    return c = null, z(b) || (l.fn = A), k || (k = h.$$watchers = []), k.unshift(l), 
                    p(this, 1), function() {
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        var b, d, g, h;
                        if (!y(e)) {
                            if (D(e)) if (ta(e)) for (f !== n && (f = n, u = f.length = 0, l++), a = e.length, 
                ...
                $digest: function() {
                    ...
                    n("$digest"), h.$$checkUrlChange(), this === J && null !== e && (h.defer.cancel(e), 
                    B()), c = null;
                    do {
                        ...
                        a: do {
                            if (p = t.$$watchers) for (u = p.length; u--; ) try {
                                ...
                                } else r = !0, c = a, a.last = a.eq ? pa(g, null) : g, l = a.fn, l(g, k === s ? g : k, t), 
                                5 > q && (A = 4 - q, y[A] || (y[A] = []), y[A].push({
                ...
                $destroy: function() {
                    if (!this.$$destroyed) {
                        var a = this.$parent;
                        this.$broadcast("$destroy"), this.$$destroyed = !0, this === J && h.$$applicationDestroyed(), 
    ...
    function Af() {
        this.$get = [ "$window", "$document", function(a, b) {
            var h, d = {}, c = !(a.chrome && a.chrome.app && a.chrome.app.runtime) && a.history && a.history.pushState, e = Z((/android (\d+)/.exec(Q((a.navigator || {}).userAgent)) || [])[1]), f = /Boxee/i.test((a.navigator || {}).userAgent), g = b[0] || {}, k = /^(Moz|webkit|ms)(?=[A-Z])/, l = g.body && g.body.style, m = !1, n = !1;
            if (l) {
                for (var p in l) if (m = k.exec(p)) {
                    h = m[0], h = h[0].toUpperCase() + h.substr(1);
                    break;
                }
                h || (h = "WebkitOpacity" in l && "webkit"), m = !!("transition" in l || h + "Transition" in l), 
                n = !!("animation" in l || h + "Animation" in l), !e || m && n || (m = G(l.webkitTransition), 
    ...
    function zd(a) {
        ...
        return function() {
            ...
            k = g.indexOf("="), 0 < k && (l = b(g.substring(0, k)), y(c[l]) && (c[l] = b(g.substring(k + 1))));
            return c;
        };
    }
    function Jf() {
    ...
    function Mc(a) {
        ...
        } ], b("currency", Ad), b("date", Bd), b("filter", qg), b("json", rg), b("limitTo", sg), 
        b("lowercase", tg), b("number", Cd), b("orderBy", Dd), b("uppercase", ug);
    }
    function qg() {
    ...
    function vg(a, b, d, c) {
        ...
        return !0 === b ? b = na : z(b) || (b = function(a, b) {
            return !y(a) && (null === a || null === b ? a === b : !(D(b) || D(a) && !vc(a)) && (a = Q("" + a), 
            b = Q("" + b), -1 !== a.indexOf(b)));
        }), function(f) {
    ...
    function wg(a) {
        var d, c, e, f, g, b = 0;
        for (-1 < (c = a.indexOf(Fd)) && (a = a.replace(Fd, "")), 0 < (e = a.search(/e/i)) ? (0 > c && (c = e), 
        ...
        return c > Gd && (d = d.splice(0, Gd - 1), b = c - 1, c = 1), {
            d: d,
            e: b,
            i: c
        };
    ...
    function Ed(a, b, d, c, e) {
        ...
        if (f) k = "∞"; else {
            for (g = wg(h), xg(g, e, b.minFrac, b.maxFrac), k = g.d, h = g.i, e = g.e, f = [], 
            ...
            k.length && h.unshift(k.join("")), k = h.join(d), f.length && (k += c + f.join("")), 
            e && (k += "e+" + e);
        }
    ...
    function Kb(a, b, d, c) {
        var e = "";
        for ((0 > a || c && 0 >= a) && (c ? a = -a + 1 : (a = -a, e = "-")), a = "" + a; a.length < b; ) a = mc + a;
    ...
    function Id(a) {
        return function(b) {
            ...
            b = 1 + Math.round(b / 6048e5), Kb(b, a);
        };
    }
    function nc(a, b) {
    ...
    function Bd(a) {
        function b(a) {
            ...
            if (b = a.match(d)) {
                ...
                b[9] && (f = Z(b[9] + b[10]), g = Z(b[9] + b[11])), h.call(a, Z(b[1]), Z(b[2]) - 1, Z(b[3])), 
                f = Z(b[4] || 0) - f, g = Z(b[5] || 0) - g, h = Z(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), 
                k.call(a, f, g, h, b);
            }
            return a;
        }
        ...
        return function(c, d, f) {
            var k, l, g = "", h = [];
            if (d = d || "mediumDate", d = a.DATETIME_FORMATS[d] || d, G(c) && (c = yg.test(c) ? Z(c) : b(c)), 
            T(c) && (c = new Date(c)), !da(c) || !isFinite(c.getTime())) return c;
    ...
    function sg() {
        return function(a, b, d) {
            return b = 1 / 0 === Math.abs(Number(b)) ? Number(b) : Z(b), isNaN(b) ? a : (T(a) && (a = a.toString()), 
            ta(a) ? (d = !d || isNaN(d) ? 0 : Z(d), d = 0 > d ? Math.max(0, a.length + d) : d, 
            0 <= b ? oc(a, d, d + b) : 0 === d ? oc(a, b, a.length) : oc(a, Math.max(0, d + b), d)) : a);
        };
    }
    function oc(a, b, d) {
    ...
    function Dd(a) {
        function b(b) {
            return b.map(function(b) {
                var c = 1, d = Xa;
                if (z(b)) d = b; else if (G(b) && ("+" != b.charAt(0) && "-" != b.charAt(0) || (c = "-" == b.charAt(0) ? -1 : 1, 
                b = b.substring(1)), "" !== b && (d = a(b), d.constant))) var e = d(), d = function(a) {
                    return a[e];
                };
                return {
                    get: d,
        ...
        function c(a, b) {
            ...
            if (d === k) {
                ...
                "string" === d ? (k = k.toLowerCase(), l = l.toLowerCase()) : "object" === d && (D(k) && (k = a.index), 
                D(l) && (l = b.index)), k !== l && (c = k < l ? -1 : 1);
            } else c = d < k ? -1 : 1;
            return c;
        }
            ...
            return a = Array.prototype.map.call(a, function(a, b) {
                return {
                    ...
                    predicateValues: k.map(function(c) {
                        var e = c.get(a);
                        return c = typeof e, null === e ? (c = "string", e = "null") : "object" === c && (z(e.valueOf) && (e = e.valueOf(), 
                        d(e)) || vc(e) && (e = e.toString(), d(e))), {
                            value: e,
                            type: c,
                            index: b
                        };
    ...
    function Ta(a) {
        return z(a) && (a = {
            link: a
        }), a.restrict = a.restrict || "AC", ha(a);
    }
    function Jd(a, b, d, c, e) {
        var f = this, g = [];
        f.$error = {}, f.$$success = {}, f.$pending = void 0, f.$name = e(b.name || b.ngForm || "")(d), 
        f.$dirty = !1, f.$pristine = !0, f.$valid = !0, f.$invalid = !1, f.$submitted = !1, 
        f.$$parentForm = Lb, f.$rollbackViewValue = function() {
            q(g, function(a) {
                a.$rollbackViewValue();
            });
            ...
            c.setClass(a, Ua, Mb + " ng-submitted"), f.$dirty = !1, f.$pristine = !0, f.$submitted = !1, 
            q(g, function(a) {
                a.$setPristine();
            });
    ...
    function Kd(a) {
        ...
        f[Od] = !(f[ob] = e.hasClass(ob)), c.$setValidity = function(a, e, f) {
            y(e) ? (c.$pending || (c.$pending = {}), g(c.$pending, a, f)) : (c.$pending && h(c.$pending, a, f), 
            Pd(c.$pending) && (c.$pending = void 0)), Ga(e) ? e ? (h(c.$error, a, f), g(c.$$success, a, f)) : (g(c.$error, a, f), 
            h(c.$$success, a, f)) : (h(c.$error, a, f), h(c.$$success, a, f)), c.$pending ? (b(Qd, !0), 
            c.$valid = c.$invalid = void 0, d("", null)) : (b(Qd, !1), c.$valid = Pd(c.$error), 
            c.$invalid = !c.$valid, d("", c.$valid)), e = c.$pending && c.$pending[a] ? void 0 : !c.$error[a] && (!!c.$$success[a] || null), 
    ...
    var Ea, F, qa, Ub, Cg = /^\/(.+)\/([a-z]*)$/, ua = Object.prototype.hasOwnProperty, Q = function(a) {
        return G(a) ? a.toLowerCase() : a;
    }, ub = function(a) {
        return G(a) ? a.toUpperCase() : a;
    }, va = [].slice, bg = [].splice, Dg = [].push, ma = Object.prototype.toString, wc = Object.getPrototypeOf, xa = N("ng"), ca = C.angular || (C.angular = {}), pb = 0;
    ...
    ja.optgroup = ja.option, ja.tbody = ja.tfoot = ja.colgroup = ja.caption = ja.thead, 
    ja.th = ja.td;
    ...
    q({
        ...
        hasClass: zb,
        css: function(a, b, d) {
            return b = db(b), w(d) ? void (a.style[b] = d) : a.style[b];
        },
        attr: function(a, b, d) {
            var c = a.nodeType;
            ...
            } else if (w(d)) a.setAttribute(b, d); else if (a.getAttribute) return a = a.getAttribute(b, 2), 
            null === a ? void 0 : a;
        },
        prop: function(a, b, d) {
            return w(d) ? void (a[b] = d) : a[b];
        },
        text: function() {
            function a(a, d) {
                if (y(d)) {
        ...
        html: function(a, b) {
            return y(b) ? a.innerHTML : (wb(a, !0), void (a.innerHTML = b));
        },
        empty: Tc
    }, function(a, b) {
    ...
    var Rd = N("$animate"), $e = function() {
        ...
        this.$get = [ "$$AnimateRunner", "$rootScope", function(d, c) {
            ...
            return {
                ...
                push: function(g, h, k, l) {
                    ...
                    b.push(g), 1 === b.length && c.$$postDigest(f))), g = new d(), g.complete(), g;
                }
            };
        } ];
        ...
        this.$$registeredAnimations = Object.create(null), this.register = function(d, c) {
            ...
            return {
                ...
                setClass: function(b, c, g, h) {
                    return h = Ia(h), h.addClass = gb(h.addClass, c), h.removeClass = gb(h.removeClass, g), 
                    a.push(b, "setClass", h);
                },
                animate: function(b, c, g, h, k) {
                    return k = Ia(k), k.from = k.from ? S(k.from, c) : c, k.to = k.to ? S(k.to, g) : g, 
                    k.tempClasses = gb(k.tempClasses, h || "ng-inline-animate"), a.push(b, "animate", k);
                }
            };
        } ];
    } ], cf = function() {
        ...
        this.$get = [ "$$rAF", "$q", "$$AnimateRunner", function(a, b, d) {
            return function(b, e) {
                ...
                var g = e || {};
                g.$$prepared || (g = pa(g)), g.cleanupStyles && (g.from = g.to = null), g.from && (b.css(g.from), 
                g.from = null);
                var h, k = new d();
                return {
                    start: f,
    ...
    jc.prototype = {
        ...
        readString: function(a) {
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length; ) {
                ...
                this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += Jg[f] || f, e = !1; else if ("\\" === f) e = !0; else {
    ...
    s.NGValueParameter = "NGValueParameter", s.prototype = {
        ...
        compile: function(a, b) {
            ...
            var f, e = "";
            return this.stage = "assign", (f = rd(c)) && (this.state.computing = "assign", e = this.nextId(), 
            this.recurse(f, e), this.return_(e), e = "fn.assign=" + this.generateFunction("assign", "s,v,l")), 
            f = pd(c.body), d.stage = "inputs", q(f, function(a, b) {
                var c = "fn" + b;
                d.state[c] = {
                    vars: [],
                    body: [],
            ...
            this.state = this.stage = void 0, e.literal = sd(c), e.constant = c.constant, e;
        },
        USE: "use",
        STRICT: "strict",
        watchFns: function() {
        ...
        recurse: function(a, b, d, c, e, f) {
            ...
            if (c = c || A, !f && w(a.watchId)) b = b || this.nextId(), this.if_("i", this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, e, !0)); else switch (a.type) {
              ...
              case s.Identifier:
                ...
                d.computed = !1, d.name = a.name), Sa(a.name), k.if_("inputs" === k.stage || k.not(k.getHasOwnProperty("l", a.name)), function() {
                ...
                }, b && k.lazyAssign(b, k.nonComputedMember("l", a.name))), (k.state.expensiveChecks || Jb(a.name)) && k.addEnsureSafeObject(b), 
                c(b);
                break;
              ...
              case s.MemberExpression:
                g = d && (d.context = this.nextId()) || this.nextId(), b = b || this.nextId(), k.recurse(a.object, g, void 0, function() {
                    k.if_(k.notNull(g), function() {
                        e && 1 !== e && k.addEnsureSafeAssignContext(g), a.computed ? (h = k.nextId(), k.recurse(a.property, h), 
                        k.getStringValue(h), k.addEnsureSafeMemberName(h), e && 1 !== e && k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), "{}")), 
                        m = k.ensureSafeObject(k.computedMember(g, h)), k.assign(b, m), d && (d.computed = !0, 
                        d.name = h)) : (Sa(a.property.name), e && 1 !== e && k.if_(k.not(k.nonComputedMember(g, a.property.name)), k.lazyAssign(k.nonComputedMember(g, a.property.name), "{}")), 
                        m = k.nonComputedMember(g, a.property.name), (k.state.expensiveChecks || Jb(a.property.name)) && (m = k.ensureSafeObject(m)), 
        ...
        recurse: function(a, b, d) {
            ...
            switch (a.type) {
              ...
              case s.MemberExpression:
                return c = this.recurse(a.object, !1, !!d), a.computed || (Sa(a.property.name, f.expression), 
              ...
              case s.AssignmentExpression:
                return c = this.recurse(a.left, !0, 1), e = this.recurse(a.right), function(a, d, g, m) {
                    var n = c(a, d, g, m);
                    return a = e(a, d, g, m), ra(n.value, f.expression), Ib(n.context), n.context[n.name] = a, 
                    b ? {
                        value: a
                    } : a;
                };
        ...
        "unary+": function(a, b) {
            return function(d, c, e, f) {
                return d = a(d, c, e, f), d = w(d) ? +d : 0, b ? {
                    value: d
                } : d;
            };
        },
        ...
        "binary-": function(a, b, d) {
            return function(c, e, f, g) {
                var h = a(c, e, f, g);
                return c = b(c, e, f, g), h = (w(h) ? h : 0) - (w(c) ? c : 0), d ? {
                    value: h
                } : h;
            };
        },
        ...
        identifier: function(a, b, d, c, e) {
            return function(f, g, h, k) {
                return f = g && a in g ? g : f, c && 1 !== c && f && !f[a] && (f[a] = {}), g = f ? f[a] : void 0, 
                b && ra(g, e), d ? {
                    context: f,
                    name: a,
                    value: g
        ...
        computedMember: function(a, b, d, c, e) {
            return function(f, g, h, k) {
                var m, n, l = a(f, g, h, k);
                return null != l && (m = b(f, g, h, k), m += "", Sa(m, e), c && 1 !== c && (Ib(l), 
                l && !l[m] && (l[m] = {})), n = l[m], ra(n, e)), d ? {
                    context: l,
                    name: m,
                    value: n
                } : n;
        ...
        nonComputedMember: function(a, b, d, c, e, f) {
            return function(g, h, k, l) {
                return g = a(g, h, k, l), e && 1 !== e && (Ib(g), g && !g[b] && (g[b] = {})), h = null != g ? g[b] : void 0, 
                (d || Jb(b)) && ra(h, f), c ? {
                    context: g,
                    name: b,
                    value: h
    ...
    q(Eb, function(a, b) {
        ...
        vb[b] = function() {
            return {
                priority: 100,
                link: function(a, c, e) {
                    return "ngPattern" === b && "/" == e.ngPattern.charAt(0) && (c = e.ngPattern.match(Cg)) ? void e.$set("ngPattern", new RegExp(c[1], c[2])) : void a.$watch(e[b], function(a) {
                        e.$set(b, a);
                    });
                }
            };
    ...
    var Ee = [ "$animate", "$compile", function(a, b) {
        return {
            ...
            link: function(d, c, e, f, g) {
                ...
                d.$watch(e.ngIf, function(d) {
                    ...
                    }) : (l && (l.remove(), l = null), k && (k.$destroy(), k = null), h && (l = tb(h.clone), 
        ...
        this.$pending = void 0, this.$name = l(d.name || "", !1)(a), this.$$parentForm = Lb;
        ...
        Kd({
            ...
            var a = r.$viewValue;
            g.cancel(s), (r.$$lastCommittedViewValue !== a || "" === a && r.$$hasNativeValidators) && (r.$$updateEmptyClasses(a), 
            r.$$lastCommittedViewValue = a, r.$pristine && this.$setDirty(), this.$$parseAndValidate());
        }, this.$$parseAndValidate = function() {
            var b = r.$$lastCommittedViewValue;
            if (B = !y(b) || void 0) for (var c = 0; c < r.$parsers.length; c++) if (b = r.$parsers[c](b), 
            y(b)) {
                B = !1;
                break;
            }
            ...
            r.$$rawModelValue = b, e && (r.$modelValue = b, r.$modelValue !== d && r.$$writeModelToScope()), 
            ...
            if (b !== r.$modelValue && (r.$modelValue === r.$modelValue || b === b)) {
                ...
                r.$render(), r.$$runValidators(b, e, A));
            }
            return b;
        });
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, b) {
                var d = this;
                this.$options = pa(a.$eval(b.ngModelOptions)), w(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, 
                ...
                post: function(d, h, k, l) {
                    ...
                    function n() {
                        ...
                        v && h.prepend(B), t.items.forEach(function(a) {
                            var b;
                            if (w(a.group)) {
                                b = d[a.group], b || (b = f.cloneNode(!1), C.appendChild(b), b.label = null === a.group ? "null" : a.group, 
                                d[a.group] = b);
                                var c = e.cloneNode(!1);
                            } else b = C, c = e.cloneNode(!1);
                            b.appendChild(c), m(a, c);
                        }), h[0].appendChild(C), s.$render(), s.$isEmpty(a) || (b = p.readValue(), (K.trackBy || y ? na(a, b) : a === b) || (s.$setViewValue(b), 
                        s.$render()));
                    }
                    ...
                    y ? (s.$isEmpty = function(a) {
                        ...
                        b ? (h[0].value !== b.selectValue && (z.remove(), v || B.remove(), h[0].value = b.selectValue, 
                        b.element.selected = !0), b.element.setAttribute("selected", "selected")) : null === a || v ? (z.remove(), 
                        v || h.prepend(B), h.val(""), B.prop("selected", !0), B.attr("selected", !0)) : (v || B.remove(), 
                        h.prepend(z), h.val("?"), z.prop("selected", !0), z.attr("selected", !0));
                    }, p.readValue = function() {
                    ...
                    h.empty(), n(), d.$watchCollection(K.getWatchables, n);
                }
            }
        };
        ...
        return {
            link: function(f, g, h) {
                ...
                var v, l = h.count, m = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, p = f.$eval(m) || {}, s = {}, w = b.startSymbol(), B = b.endSymbol(), r = w + l + "-" + n + B, z = ca.noop;
                q(h, function(a, b) {
                    var c = e.exec(b);
                    ...
                    e || c in p || (c = a.pluralCat(c - n)), c === v || e && T(v) && isNaN(v) || (z(), 
                    e = s[c], y(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), 
                    z = A, k()) : z = f.$watch(e, k), v = c);
                });
            }
        };
    } ], Je = [ "$parse", "$animate", "$compile", function(a, b, d) {
        var c = N("ngRepeat"), e = function(a, b, c, d, e, m, n) {
            a[c] = d, e && (a[e] = m), a.$index = b, a.$first = 0 === b, a.$last = b === n - 1, 
            ...
            compile: function(f, g) {
                ...
                return s ? r = a(s) : (v = function(a, b) {
                    ...
                    a.$watchCollection(n, function(f) {
                        ...
                        if (p && (a[p] = f), ta(f)) G = f, n = z || v; else for (H in n = z || A, G = [], 
                        f) ua.call(f, H) && "$" !== H.charAt(0) && G.push(H);
                        for (t = G.length, H = Array(t), g = 0; g < t; g++) if (C = f === G ? g : G[g], 
                        F = f[C], E = n(C, F, g), m[E]) D = m[E], delete m[E], u[E] = D, H[g] = D; else {
                        ...
                        for (g = 0; g < t; g++) if (C = f === G ? g : G[g], F = f[C], D = H[g], D.scope) {
                            ...
                            D.clone[0] != s && b.move(tb(D.clone), null, r), r = D.clone[D.clone.length - 1], 
        ...
        return {
            ...
            compile: function(b) {
                ...
                return b.empty(), function(a, b, f, g, h) {
                    ...
                    f.ngTransclude === f.$attr.ngTransclude && (f.ngTransclude = ""), f = f.ngTransclude || f.ngTranscludeSlot, 
                    h(function(a, c) {
    ...
    le(ca), ca.module("ngLocale", [], [ "$provide", function(a) {
        function b(a) {
            a += "";
            var b = a.indexOf(".");
...
function(E, d) {
    function y(t, l, g) {
        return {
            ...
            link: function(b, e, a, c, k) {
                function p() {
                    m && (g.cancel(m), m = null), h && (h.$destroy(), h = null), n && (m = g.leave(n), 
                    m.then(function() {
                        m = null;
                    }), n = null);
                }
                function B() {
                    ...
                    if (d.isDefined(a && a.$template)) {
                        ...
                        }), h = c.scope = a, h.$emit("$viewContentLoaded"), h.$eval(s);
                    } else p();
                }
                var h, n, m, A = a.autoscroll, s = a.onload || "";
                b.$on("$routeChangeSuccess", B), B();
            }
        };
    }
    function w(d, l, g) {
        return {
            ...
            link: function(b, e) {
                ...
                if (a.controller) {
                    ...
                    a.controllerAs && (b[a.controllerAs] = p), e.data("$ngControllerController", p), 
    ...
    var x, C, s = d.module("ngRoute", [ "ng" ]).provider("$route", function() {
        ...
        function l(b, d) {
            var a = d.caseInsensitiveMatch, c = {
                originalPath: b,
                regexp: b
            }, g = c.keys = [];
            return b = b.replace(/([().])/g, "\\$1").replace(/(\/)?:(\w+)(\*\?|[\?\*])?/g, function(b, a, d, c) {
                return b = "?" === c || "*?" === c ? "?" : null, c = "*" === c || "*?" === c ? "*" : null, 
                g.push({
                    name: d,
                    optional: !!b
                }), a = a || "", "" + (b ? "" : a) + "(?:" + (b ? a : "") + (c && "(.+?)" || "([^/]+)") + (b || "") + ")" + (b || "");
            }).replace(/([\/$\*])/g, "\\$1"), c.regexp = new RegExp("^" + b + "$", a ? "i" : ""), 
            c;
        }
        ...
        this.when = function(b, e) {
            ...
            } else if (C(e)) for (c in a = a || {}, e) "$" === c.charAt(0) && "$" === c.charAt(1) || (a[c] = e[c]);
            return a = a || e, d.isUndefined(a.reloadOnSearch) && (a.reloadOnSearch = !0), d.isUndefined(a.caseInsensitiveMatch) && (a.caseInsensitiveMatch = this.caseInsensitiveMatch), 
            g[b] = d.extend(a, b && l(b, a)), b && (c = "/" == b[b.length - 1] ? b.substr(0, b.length - 1) : b + "/", 
            g[c] = d.extend({
                redirectTo: b
            }, l(c, a))), this;
            ...
            function n() {
                var u = v.current, f = r;
                x ? (u.params = f.params, d.copy(u.params, a), b.$broadcast("$routeUpdate", u)) : (f || u) && (z = !1, 
                (v.current = f) && f.redirectTo && (d.isString(f.redirectTo) ? e.path(w(f.redirectTo, f.params)).search(f.params).replace() : e.url(f.redirectTo(f.pathParams, e.path(), e.search())).replace()), 
                c.when(f).then(m).then(function(c) {
            ...
            function m(a) {
                if (a) {
                    ...
                    return d.forEach(b, function(a, c) {
                        b[c] = d.isString(a) ? k.get(a) : k.invoke(a, null, null, c);
                    }), a = s(a), d.isDefined(a) && (b.$template = a), c.all(b);
                }
            }
            function s(a) {
                var b, c;
                return d.isDefined(b = a.template) ? d.isFunction(b) && (b = b(a.params)) : d.isDefined(c = a.templateUrl) && (d.isFunction(c) && (c = c(a.params)), 
                d.isDefined(c) && (a.loadedTemplateUrl = l.valueOf(c), b = p(c))), b;
            }
            function y() {
                var a, b;
                return d.forEach(g, function(c, g) {
                    var q;
                    if (q = !b) {
                        var h = e.path();
                        q = c.keys;
            ...
            function w(a, b) {
                ...
                return d.forEach((a || "").split(":"), function(a, d) {
                    if (0 === d) c.push(a); else {
                        ...
                        c.push(b[g]), c.push(e[2] || ""), delete b[g];
                    }
                }), c.join("");
            }
            var r, x, z = !1, v = {
                ...
                updateParams: function(a) {
                    if (!this.current || !this.current.$$route) throw D("norout");
                    a = d.extend({}, this.current.params, a), e.path(w(this.current.$$route.originalPath, a)), 
                    e.search(a);
                }
            };
            return b.$on("$locationChangeStart", h), b.$on("$locationChangeSuccess", n), v;
        } ];
    }), D = d.$$minErr("ngRoute");
    ...
    }), s.directive("ngView", y), s.directive("ngView", w), y.$inject = [ "$route", "$anchorScroll", "$animate" ], 
    w.$inject = [ "$compile", "$controller", "$route" ];
}(window, window.angular), function(P, d) {
    function G(t, g) {
    ...
    d.module("ngResource", [ "ng" ]).provider("$resource", function() {
        ...
        this.defaults = {
            ...
            function J(e, h, n, k) {
                function b(a, c) {
                    var b = {};
                    return c = v({}, h, c), u(c, function(c, h) {
                        x(c) && (c = c(a));
                        var f;
                        if (c && c.charAt && "@" == c.charAt(0)) {
                            f = a;
                            var l = c.substr(1);
                            if (null == l || "" === l || "hasOwnProperty" === l || !M.test("." + l)) throw z("badmember", l);
                ...
                var t = new B(e, k);
                return n = v({}, g.defaults.actions, n), m.prototype.toJSON = function() {
                    var a = v({}, this);
                    ...
                    delete a.timeout, e = null), m[c] = function(f, l, k, g) {
                        var n, w, C, r = {};
                        switch (arguments.length) {
                          case 4:
                            C = g, w = k;
                        ...
                        var y, F, D = this instanceof m, p = D ? n : a.isArray ? [] : new m(n), s = {}, A = a.interceptor && a.interceptor.response || N, B = a.interceptor && a.interceptor.responseError || void 0;
                        ...
                        h && (s.data = n), t.setUrlParams(s, v({}, b(n, a.params || {}), r), a.url), r = q(s).then(function(f) {
                            var b = f.data;
                            if (b) {
                                if (d.isArray(b) !== !!a.isArray) throw z("badcfg", c, a.isArray ? "array" : "object", d.isArray(b) ? "array" : "object", s.method, s.url);
                                if (a.isArray) p.length = 0, u(b, function(a) {
                                    "object" == typeof a ? p.push(new m(a)) : p.push(a);
                                }); else {
                                    var l = p.$promise;
                                    G(b, p), p.$promise = l;
                                }
                            }
                            return f.resource = p, f;
                        }, function(a) {
                            return (C || K)(a), H.reject(a);
                        }), r.finally(function() {
                            p.$resolved = !0, !D && E && (p.$cancelRequest = d.noop, I.cancel(F), y = F = s.timeout = null);
                        }), r = r.then(function(a) {
                            var c = A(a);
                            return (w || K)(c, a.headers), c;
                        }, B), D ? r : (p.$promise = r, p.$resolved = !1, E && (p.$cancelRequest = y.resolve), 
                        p);
                    }, m.prototype["$" + c] = function(a, b, d) {
                        return x(a) && (d = b, b = a, a = {}), a = m[c].call(this, a, this, b, d), a.$promise || a;
                    };
                }), m.bind = function(a) {
                    return J(e, v({}, h, a), n);
                }, m;
            ...
            return B.prototype = {
                setUrlParams: function(e, h, n) {
                    var g, m, k = this, b = n || k.template, q = "", a = k.urlParams = {};
                    u(b.split(/\W/), function(c) {
                        if ("hasOwnProperty" === c) throw z("badname");
                        !/^\d+$/.test(c) && c && new RegExp("(^|[^\\\\]):" + c + "(\\W|$)").test(b) && (a[c] = {
                            isQueryParamValue: new RegExp("\\?.*=:" + c + "(?:\\W|$)").test(b)
                        });
                    }), b = b.replace(/\\:/g, ":"), b = b.replace(t, function(a) {
                        return q = a, "";
                    }), h = h || {}, u(k.urlParams, function(a, e) {
                        g = h.hasOwnProperty(e) ? h[e] : k.defaults[e], d.isDefined(g) && null !== g ? (m = a.isQueryParamValue ? A(g, !0) : A(g, !0).replace(/%26/gi, "&").replace(/%3D/gi, "=").replace(/%2B/gi, "+"), 
                        b = b.replace(new RegExp(":" + e + "(\\W|$)", "g"), function(a, c) {
                            return m + c;
                        })) : b = b.replace(new RegExp("(/?):" + e + "(\\W|$)", "g"), function(a, c, b) {
                            return "/" == b.charAt(0) ? b : c + b;
                        });
                    }), k.defaults.stripTrailingSlashes && (b = b.replace(/\/+$/, "") || "/"), b = b.replace(/\/\.(?=\w+($|\?))/, "."), 
                    e.url = q + b.replace(/\/\\\./, "/."), u(h, function(a, b) {
    ...
    function V(a) {
        return function(b, c) {
            c.addClass && (Pa(a, b, c.addClass), c.addClass = null), c.removeClass && (Qa(a, b, c.removeClass), 
            c.removeClass = null);
        };
    }
    function oa(a) {
    ...
    function W(a, b, c) {
        ...
        return a = Ra(a.attr("class"), e, l), c.preparationClasses && (d.preparationClasses = $(c.preparationClasses, d.preparationClasses), 
        delete c.preparationClasses), e = d.domOperation !== P ? d.domOperation : null, 
        ua(d, c), e && (d.domOperation = e), d.addClass = a.addClass ? a.addClass : null, 
    ...
    function Ra(a, b, c) {
        ...
        return s(e, function(b, c) {
            var d, e;
            1 === b ? (d = "addClass", e = !a[c] || a[c + "-remove"]) : -1 === b && (d = "removeClass", 
            e = a[c] || a[c + "-add"]), e && (l[d].length && (l[d] += " "), l[d] += c);
        }), l;
    }
    function y(a) {
    ...
    function Sa(a, b, c) {
        var d = "";
        b && (d = Z(b, "ng-", !0)), c.addClass && (d = $(d, Z(c.addClass, "-add"))), c.removeClass && (d = $(d, Z(c.removeClass, "-remove"))), 
    ...
    var S, ya, aa, za;
    void 0 === R.ontransitionend && void 0 !== R.onwebkittransitionend ? (S = "WebkitTransition", 
    ya = "webkitTransitionEnd transitionend") : (S = "transition", ya = "transitionend"), 
    void 0 === R.onanimationend && void 0 !== R.onwebkitanimationend ? (aa = "WebkitAnimation", 
    za = "webkitAnimationEnd animationend") : (aa = "animation", za = "animationend");
    var Ba, ua, s, Y, xa, ea, Ca, ba, G, J, F, P, qa = aa + "Delay", Aa = aa + "Duration", ma = S + "Delay", La = S + "Duration", Ma = B.$$minErr("ng"), Ua = {
    ...
    B.module("ngAnimate", [], function() {
        P = B.noop, Ba = B.copy, ua = B.extend, F = B.element, s = B.forEach, Y = B.isArray, 
        G = B.isString, ba = B.isObject, J = B.isUndefined, xa = B.isDefined, Ca = B.isFunction, 
        ea = B.isElement;
        ...
        return {
            ...
            link: function(b, d, e, l, n) {
                ...
                b.$watchCollection(e.ngAnimateSwap || e.for, function(e) {
                    I && a.leave(I), g && (g.$destroy(), g = null), (e || 0 === e) && (g = b.$new(), 
                    n(g, function(b) {
        ...
        l.join.push(function(a, b, c) {
            ...
            function p(a, h, v) {
                ...
                function k(b) {
                    ...
                    f.activeClasses && (c.removeClass(f.activeClasses), f.activeClasses = null), E(a, m), 
                    ha(a, m), m.domOperation(), A.complete(!b);
                }
                var p, T, m = Ba(v);
                (a = Oa(a)) && (p = y(a), T = a.parent());
                var m = oa(m), A = new Q(), sa = O();
                if (Y(m.addClass) && (m.addClass = m.addClass.join(" ")), m.addClass && !G(m.addClass) && (m.addClass = null), 
                Y(m.removeClass) && (m.removeClass = m.removeClass.join(" ")), m.removeClass && !G(m.removeClass) && (m.removeClass = null), 
                m.from && !ba(m.from) && (m.from = null), m.to && !ba(m.to) && (m.to = null), !p) return k(), 
                A;
                if (v = [ p.className, m.addClass, m.removeClass ].join(" "), !Xa(v)) return k(), 
                A;
                var g = 0 <= [ "enter", "move", "leave" ].indexOf(h), w = l[0].hidden, t = !f || w || N.get(p);
                v = !t && z.get(p) || {};
                var H = !!v.state;
                if (t || H && 1 == v.state || (t = !M(a, T, h)), t) return w && r(A, h, "start"), 
                k(), w && r(A, h, "close"), A;
                if (g && K(a), w = {
                    structural: g,
                    element: a,
                    ...
                    if (d("cancel", a, w, v)) if (2 === v.state) v.runner.end(); else {
                        ...
                        if (2 !== v.state) return Sa(a, g ? h : null, m), h = w.event = v.event, m = W(a, v, w), 
                        v.runner;
                        W(a, w, {});
                    }
                } else W(a, w, {});
                if ((H = w.structural) || (H = "animate" === w.event && 0 < Object.keys(w.options.to || {}).length || e(w)), 
                !H) return k(), ka(a), A;
                var C = (v.counter || 0) + 1;
                return w.counter = C, L(a, 1, w), c.$$postDigest(function() {
                    ...
                    c || b.counter !== C || !f ? (c && (E(a, m), ha(a, m)), (c || g && b.event !== h) && (m.domOperation(), 
                    A.end()), f || ka(a)) : (h = !b.structural && e(b, !0) ? "setClass" : b.event, L(a, 2), 
                    b = Wa(a, h, b.options), A.setHost(b), r(A, h, "start", {}), b.done(function(b) {
            ...
            function M(a, b, c) {
                ...
                for ((a = F.data(a[0], "$ngAnimatePin")) && (b = a), b = y(b); b && (d || (d = k(b, g)), 
                1 === b.nodeType); ) {
                    if (a = z.get(b) || {}, !h) {
                        var p = N.get(b);
                        if (!0 === p && !1 !== e) {
            ...
            function L(a, b, c) {
                c = c || {}, c.state = b, a = y(a), a.setAttribute("data-ng-animate", b), c = (b = z.get(a)) ? ua(b, c) : c, 
                z.put(a, c);
            }
            var z = new C(), N = new C(), f = null, A = c.$watch(function() {
                ...
                pin: function(a, b) {
                    Da(ea(a), "element", "not an element"), Da(ea(b), "parentElement", "not an element"), 
            ...
            return function(n, Q, t) {
                ...
                function T(a) {
                    ...
                    return s(c, function(c, k) {
                        ...
                        } else r = r ? r.animationID : p.animationID, p = r.toString(), d[p] || (d[p] = !0, 
                        b.push(a[r]));
                    }), b;
                }
                function O(a, b) {
                ...
                function K(b) {
                    n.off("$destroy", p), n.removeData("$$animationRunner"), C(n, t), ha(n, t), t.domOperation(), 
                    L && a.removeClass(n, L), n.removeClass("ng-animate"), k.complete(!b);
                }
                t = oa(t);
        ...
        this.$get = [ "$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$$animateQueue", function(a, e, l, n, I, g, u, C) {
            ...
            function Q(r, p, g, n) {
                var k;
                return 0 < b.count(g) && (k = c.get(g), k || (p = Z(p, "-stagger"), e.addClass(r, p), 
                k = Ha(a, r, n), k.animationDuration = Math.max(k.animationDuration, 0), k.transitionDuration = Math.max(k.transitionDuration, 0), 
                e.removeClass(r, p), c.put(g, k))), k || {};
            }
            function t(a) {
            ...
            function H(c, e, g) {
                return e = b.get(g), e || (e = Ha(a, c, Ua), "infinite" === e.animationIterationCount && (e.animationIterationCount = 1)), 
                b.put(g, e), c = e, g = c.animationDelay, e = c.transitionDelay, c.maxDelay = g && e ? Math.max(g, e) : g || e, 
            ...
            return function(a, c) {
                ...
                function k(b) {
                    if (!(w || F && O)) {
                        w = !0, O = !1, f.$$skipPreparationClasses || e.removeClass(a, ga), e.removeClass(a, ea), 
                        va(h, !1), pa(h, !1), s(x, function(a) {
                            h.style[a[0]] = "";
                ...
                function z(a) {
                    ...
                    a = b.$manualTimeStamp || Date.now(), b = parseFloat(b.elapsedTime.toFixed(3)), 
                ...
                function N() {
                    function b() {
                        if (!w) {
                            if (M(!1), s(x, function(a) {
                                ...
                                if (na = h.className + " " + ga, ia = B(h, na), D = H(h, na, ia), ca = D.maxDelay, 
                                J = Math.max(ca, 0), m = D.maxDuration, 0 === m) return void k();
                                q.hasTransitions = 0 < D.transitionDuration, q.hasAnimations = 0 < D.animationDuration;
                            }
                            if (q.applyAnimationDelay && (ca = "boolean" != typeof f.delay && wa(f.delay) ? parseFloat(f.delay) : ca, 
                            J = Math.max(ca, 0), D.animationDelay = ca, da = [ qa, ca + "s" ], x.push(da), h.style[da[0]] = da[1]), 
                            R = 1e3 * J, V = 1e3 * m, f.easing) {
                                var d, g = f.easing;
                            ...
                            N && (p = n(c, p, !1), g[0] = {
                                timer: p,
                                expectedEndTime: d
                            }, g.push(k), a.data("$$animateCss", g)), fa.length && a.on(fa.join(" "), z), f.to && (f.cleanupStyles && Ka(A, h, Object.keys(f.to)), 
                            Ga(a, f));
                        }
                    }
                    function c() {
                    ...
                    if (!w) if (h.parentNode) {
                        var d = function(a) {
                            if (F) O && a && (O = !1, k()); else if (O = !a, D.animationDuration) if (a = va(h, O), 
                            O) x.push(a); else {
                ...
                ja && f.structural ? $ = Z(ja, "ng-", !0) : ja && ($ = ja), f.addClass && (U += Z(f.addClass, "-add")), 
                f.removeClass && (U.length && (U += " "), U += Z(f.removeClass, "-remove")), f.applyClassesEarly && U.length && T(a, f);
                ...
                0 < f.stagger ? (E = parseFloat(f.stagger), X = {
                    ...
                    animationDuration: 0
                }) : (ia = B(h, na), X = Q(h, ga, ia, Va)), f.$$skipPreparationClasses || e.addClass(a, ga), 
                f.transitionStyle && (E = [ S, f.transitionStyle ], la(h, E), x.push(E)), 0 <= f.duration && (E = 0 < h.style[S].length, 
                E = Ia(f.duration, E), la(h, E), x.push(E)), f.keyframeStyle && (E = [ aa, f.keyframeStyle ], 
                la(h, E), x.push(E));
                ...
                var q = {};
                if (q.hasTransitions = 0 < D.transitionDuration, q.hasAnimations = 0 < D.animationDuration, 
                q.hasTransitionAll = q.hasTransitions && "all" == D.transitionProperty, q.applyTransitionDuration = I && (q.hasTransitions && !q.hasTransitionAll || q.hasAnimations && !q.hasTransitions), 
                q.applyAnimationDuration = f.duration && q.hasAnimations, q.applyTransitionDelay = wa(f.delay) && (q.applyTransitionDuration || q.hasTransitions), 
                q.applyAnimationDelay = wa(f.delay) && q.hasAnimations, q.recalculateTimingStyles = 0 < U.length, 
                (q.applyTransitionDuration || q.applyAnimationDuration) && (m = f.duration ? parseFloat(f.duration) : m, 
                q.applyTransitionDuration && (q.hasTransitions = !0, D.transitionDuration = m, E = 0 < h.style[S + "Property"].length, 
                x.push(Ia(m, E))), q.applyAnimationDuration && (q.hasAnimations = !0, D.animationDuration = m, 
                x.push([ Aa, m + "s" ]))), 0 === m && !q.recalculateTimingStyles) return L();
                if (null != f.delay) {
                    var da;
                    "boolean" != typeof f.delay && (da = parseFloat(f.delay), J = Math.max(da, 0)), 
                    q.applyTransitionDelay && x.push([ ma, da + "s" ]), q.applyAnimationDelay && x.push([ qa, da + "s" ]);
                }
                return null == f.duration && 0 < D.transitionDuration && (q.recalculateTimingStyles = q.recalculateTimingStyles || ja), 
                R = 1e3 * J, V = 1e3 * m, f.skipBlocking || (q.blockTransition = 0 < D.transitionDuration, 
                q.blockKeyframeAnimation = 0 < D.animationDuration && 0 < X.animationDelay && 0 === X.animationDuration), 
                f.from && (f.cleanupStyles && Ka(A, h, Object.keys(f.from)), Fa(a, f)), q.blockTransition || q.blockKeyframeAnimation ? M(m) : f.skipBlocking || pa(h, !1), 
                {
                    $$willAnimate: !0,
                    end: d,
                    start: function() {
        ...
        a.drivers.push("$$animateCssDriver"), this.$get = [ "$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$sniffer", "$$jqLite", "$document", function(a, c, d, e, l, n, I) {
            ...
            function C(c, e, n) {
                ...
                e.addClass("ng-animate-shim"), n.addClass("ng-animate-shim"), C.addClass("ng-anchor"), 
                H.append(C);
                var M;
                if (c = function() {
                    var c = a(C, {
                ...
                return {
                    start: function() {
                        ...
                        return c.done(function() {
                            return c = null, !M && (M = p()) ? (c = M.start(), c.done(function() {
                                c = null, I(), b.complete();
                            }), c) : (I(), void b.complete());
                        }), b = new d({
                            end: a,
            ...
            function Q(c) {
                ...
                "leave" === c.event && (e.onDone = e.domOperation)), e.preparationClasses && (e.event = $(e.event, e.preparationClasses)), 
        ...
        this.$get = [ "$injector", "$$AnimateRunner", "$$jqLite", function(b, c, d) {
            ...
            return function(a, b, d, u) {
                ...
                function t(a, b, d, e, f) {
                    ...
                    if (0 === g.length) {
                        var h, k;
                        "beforeSetClass" === f ? (h = y(a, "removeClass", d, e, "beforeRemoveClass"), k = y(a, "addClass", d, e, "beforeAddClass")) : "setClass" === f && (h = y(a, "removeClass", d, e, "removeClass"), 
                        k = y(a, "addClass", d, e, "addClass")), h && (g = g.concat(h)), k && (g = g.concat(k));
                    }
                ...
                var H = !1;
                3 === arguments.length && ba(d) && (u = d, d = null), u = oa(u), d || (d = a.attr("class") || "", 
                u.addClass && (d += " " + u.addClass), u.removeClass && (d += " " + u.removeClass));
                var r, p, F = u.addClass, G = u.removeClass, x = e(d);
                if (x.length) {
                    var K, J;
                    "leave" == b ? (J = "leave", K = "afterLeave") : (J = "before" + b.charAt(0).toUpperCase() + b.substr(1), 
                    K = b), "enter" !== b && "move" !== b && (r = t(a, b, u, x, J)), p = t(a, b, u, x, K);
                }
                if (r || p) {
                    var k;
                    return {
    ...
    function dirPaginateDirective($compile, $parse, paginationService) {
        function dirPaginationCompileFn(tElement, tAttrs) {
            var expression = tAttrs.dirPaginate, match = expression.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), filterPattern = /\|\s*itemsPerPage\s*:\s*(.*\(\s*\w*\)|([^\)]*?(?=\s+as\s+))|[^\)]*)/;
            if (null === match[2].match(filterPattern)) throw "pagination directive: the 'itemsPerPage' filter must be set.";
            var itemsPerPageFilterRemoved = match[2].replace(filterPattern, ""), collectionGetter = $parse(itemsPerPageFilterRemoved);
            addNoCompileAttributes(tElement);
            var rawId = tAttrs.paginationId || DEFAULT_ID;
            return paginationService.registerInstance(rawId), function(scope, element, attrs) {
                var paginationId = $parse(attrs.paginationId)(scope) || attrs.paginationId || DEFAULT_ID;
                paginationService.registerInstance(paginationId);
                var repeatExpression = getRepeatExpression(expression, paginationId);
                addNgRepeatToElement(element, attrs, repeatExpression), removeTemporaryAttributes(element);
                var compiled = $compile(element), currentPageGetter = makeCurrentPageGetterFn(scope, attrs, paginationId);
                paginationService.setCurrentPageParser(paginationId, currentPageGetter, scope), 
                "undefined" != typeof attrs.totalItems ? (paginationService.setAsyncModeTrue(paginationId), 
                scope.$watch(function() {
                    return $parse(attrs.totalItems)(scope);
                }, function(result) {
                    0 <= result && paginationService.setCollectionLength(paginationId, result);
        ...
        function getRepeatExpression(expression, paginationId) {
            ...
            return repeatExpression = paginationId === DEFAULT_ID || idDefinedInFilter ? expression : expression.replace(/(\|\s*itemsPerPage\s*:\s*[^|\s]*)/, "$1 : '" + paginationId + "'");
        }
        function addNgRepeatToElement(element, attrs, repeatExpression) {
            element[0].hasAttribute("dir-paginate-start") || element[0].hasAttribute("data-dir-paginate-start") ? (attrs.$set("ngRepeatStart", repeatExpression), 
            element.eq(element.length - 1).attr("ng-repeat-end", !0)) : attrs.$set("ngRepeat", repeatExpression);
        }
        function addNoCompileAttributes(tElement) {
            angular.forEach(tElement, function(el) {
                1 === el.nodeType && angular.element(el).attr("dir-paginate-no-compile", !0);
            });
        }
        function removeTemporaryAttributes(element) {
            angular.forEach(element, function(el) {
                1 === el.nodeType && angular.element(el).removeAttr("dir-paginate-no-compile");
            }), element.eq(0).removeAttr("dir-paginate-start").removeAttr("dir-paginate").removeAttr("data-dir-paginate-start").removeAttr("data-dir-paginate"), 
            element.eq(element.length - 1).removeAttr("dir-paginate-end").removeAttr("data-dir-paginate-end");
        }
        function makeCurrentPageGetterFn(scope, attrs, paginationId) {
            var currentPageGetter;
            if (attrs.currentPage) currentPageGetter = $parse(attrs.currentPage); else {
                var defaultCurrentPage = (paginationId + "__currentPage").replace(/\W/g, "_");
                scope[defaultCurrentPage] = 1, currentPageGetter = $parse(defaultCurrentPage);
            }
    ...
    function dirPaginationControlsDirective(paginationService, paginationTemplate) {
        function dirPaginationControlsLinkFn(scope, element, attrs) {
            function goToPage(num) {
                paginationService.isRegistered(paginationId) && isValidPageNumber(num) && (scope.pages = generatePagesArray(num, paginationService.getCollectionLength(paginationId), paginationService.getItemsPerPage(paginationId), paginationRange), 
                scope.pagination.current = num, updateRangeValues(), scope.onPageChange && scope.onPageChange({
                    newPageNumber: num
                }));
            }
            function generatePagination() {
                if (paginationService.isRegistered(paginationId)) {
                    ...
                    scope.pagination.current = page, scope.pagination.last = scope.pages[scope.pages.length - 1], 
                    scope.pagination.last < scope.pagination.current ? scope.setCurrent(scope.pagination.last) : updateRangeValues();
                }
            }
            function updateRangeValues() {
                if (paginationService.isRegistered(paginationId)) {
                    ...
                    scope.range.lower = (currentPage - 1) * itemsPerPage + 1, scope.range.upper = Math.min(currentPage * itemsPerPage, totalItems), 
            ...
            var rawId = attrs.paginationId || DEFAULT_ID, paginationId = scope.paginationId || attrs.paginationId || DEFAULT_ID;
            if (!paginationService.isRegistered(paginationId) && !paginationService.isRegistered(rawId)) {
                var idMessage = paginationId !== DEFAULT_ID ? " (id: " + paginationId + ") " : " ";
                console.warn("Pagination directive: the pagination controls" + idMessage + "cannot be used without the corresponding pagination directive, which was not found at link time.");
            }
            scope.maxSize || (scope.maxSize = 9), scope.autoHide = void 0 === scope.autoHide || scope.autoHide, 
            ...
            scope.pages = [], scope.pagination = {
                ...
                if (paginationService.isRegistered(paginationId)) return (paginationService.getCollectionLength(paginationId) + 1) * paginationService.getItemsPerPage(paginationId);
            }, function(length) {
                0 < length && generatePagination();
            }), scope.$watch(function() {
                if (paginationService.isRegistered(paginationId)) return paginationService.getItemsPerPage(paginationId);
            }, function(current, previous) {
                current != previous && "undefined" != typeof previous && goToPage(scope.pagination.current);
            }), scope.$watch(function() {
                if (paginationService.isRegistered(paginationId)) return paginationService.getCurrentPage(paginationId);
            }, function(currentPage, previousPage) {
                currentPage != previousPage && goToPage(currentPage);
            }), scope.setCurrent = function(num) {
                paginationService.isRegistered(paginationId) && isValidPageNumber(num) && (num = parseInt(num, 10), 
        ...
        function generatePagesArray(currentPage, collectionLength, rowsPerPage, paginationRange) {
            var position, pages = [], totalPages = Math.ceil(collectionLength / rowsPerPage), halfWay = Math.ceil(paginationRange / 2);
            position = currentPage <= halfWay ? "start" : totalPages - halfWay < currentPage ? "end" : "middle";
            for (var ellipsesNeeded = paginationRange < totalPages, i = 1; i <= totalPages && i <= paginationRange; ) {
                var pageNumber = calculatePageNumber(i, currentPage, paginationRange, totalPages), openingEllipsesNeeded = 2 === i && ("middle" === position || "end" === position), closingEllipsesNeeded = i === paginationRange - 1 && ("middle" === position || "start" === position);
                ellipsesNeeded && (openingEllipsesNeeded || closingEllipsesNeeded) ? pages.push("...") : pages.push(pageNumber), 
                i++;
            }
            return pages;
        }
        function calculatePageNumber(i, currentPage, paginationRange, totalPages) {
            ...
            return i === paginationRange ? totalPages : 1 === i ? i : paginationRange < totalPages ? totalPages - halfWay < currentPage ? totalPages - paginationRange + i : halfWay < currentPage ? currentPage - halfWay + i : i : i;
        }
        var numberRegex = /^\d+$/;
        return {
            restrict: "AE",
    ...
    function itemsPerPageFilter(paginationService) {
        return function(collection, itemsPerPage, paginationId) {
            if ("undefined" == typeof paginationId && (paginationId = DEFAULT_ID), !paginationService.isRegistered(paginationId)) throw "pagination directive: the itemsPerPage id argument (id: " + paginationId + ") does not match a registered pagination-id.";
            var end, start;
            if (angular.isObject(collection)) {
                if (itemsPerPage = parseInt(itemsPerPage) || 9999999999, start = paginationService.isAsyncMode(paginationId) ? 0 : (paginationService.getCurrentPage(paginationId) - 1) * itemsPerPage, 
                end = start + itemsPerPage, paginationService.setItemsPerPage(paginationId, itemsPerPage), 
                collection instanceof Array) return collection.slice(start, end);
                var slicedObject = {};
                return angular.forEach(keys(collection).slice(start, end), function(key) {
    ...
    function keys(obj) {
        ...
        var objKeys = [];
        for (var i in obj) obj.hasOwnProperty(i) && objKeys.push(i);
        return objKeys;
    }
    function paginationService() {
        var lastRegisteredInstance, instances = {};
        this.registerInstance = function(instanceId) {
            "undefined" == typeof instances[instanceId] && (instances[instanceId] = {
                asyncMode: !1
            }, lastRegisteredInstance = instanceId);
        }, this.isRegistered = function(instanceId) {
            return "undefined" != typeof instances[instanceId];
        }, this.getLastInstanceId = function() {
            return lastRegisteredInstance;
        }, this.setCurrentPageParser = function(instanceId, val, scope) {
            instances[instanceId].currentPageParser = val, instances[instanceId].context = scope;
            ...
            instances[instanceId].asyncMode = !0;
    ...
    function l(b, a, g) {
        ...
        return function(b, e, f) {
            var g, h;
            f = f || {}, h = f.expires, g = c.isDefined(f.path) ? f.path : d, c.isUndefined(e) && (h = "Thu, 01 Jan 1970 00:00:00 GMT", 
            e = ""), c.isString(h) && (h = new Date(h)), e = encodeURIComponent(b) + "=" + encodeURIComponent(e), 
            e = e + (g ? ";path=" + g : "") + (f.domain ? ";domain=" + f.domain : ""), e += h ? ";expires=" + h.toUTCString() : "", 
            e += f.secure ? ";secure" : "", f = e.length + 1, 4096 < f && a.warn("Cookie '" + b + "' possibly not set or overflowed because it was too large (" + f + " > 4096 bytes)!"), 
            k.cookie = e;
        };
    }
    ...
    function q(a, b) {
        var c, d, e;
        if (p(b._isAMomentObject) || (a._isAMomentObject = b._isAMomentObject), p(b._i) || (a._i = b._i), 
        p(b._f) || (a._f = b._f), p(b._l) || (a._l = b._l), p(b._strict) || (a._strict = b._strict), 
        p(b._tzm) || (a._tzm = b._tzm), p(b._isUTC) || (a._isUTC = b._isUTC), p(b._offset) || (a._offset = b._offset), 
        p(b._pf) || (a._pf = m(b)), p(b._locale) || (a._locale = b._locale), rd.length > 0) for (c in rd) d = rd[c], 
        e = b[d], p(e) || (a[d] = e);
        return a;
    }
    function r(b) {
        q(this, b), this._d = new Date(null != b._d ? b._d.getTime() : NaN), sd === !1 && (sd = !0, 
        a.updateOffset(this), sd = !1);
    }
    function s(a) {
    ...
    function ha(a, b, c) {
        ...
        return c ? "MMM" === b ? (e = je.call(this._shortMonthsParse, g), e !== -1 ? e : null) : (e = je.call(this._longMonthsParse, g), 
        e !== -1 ? e : null) : "MMM" === b ? (e = je.call(this._shortMonthsParse, g), e !== -1 ? e : (e = je.call(this._longMonthsParse, g), 
        e !== -1 ? e : null)) : (e = je.call(this._longMonthsParse, g), e !== -1 ? e : (e = je.call(this._shortMonthsParse, g), 
        e !== -1 ? e : null));
    }
    function ia(a, b, c) {
        var d, e, f;
    ...
    function ma(a) {
        return this._monthsParseExact ? (i(this, "_monthsRegex") || oa.call(this), a ? this._monthsShortStrictRegex : this._monthsShortRegex) : (i(this, "_monthsShortRegex") || (this._monthsShortRegex = ne), 
        this._monthsShortStrictRegex && a ? this._monthsShortStrictRegex : this._monthsShortRegex);
    }
    function na(a) {
        return this._monthsParseExact ? (i(this, "_monthsRegex") || oa.call(this), a ? this._monthsStrictRegex : this._monthsRegex) : (i(this, "_monthsRegex") || (this._monthsRegex = oe), 
    ...
    function Ia(a, b, c) {
        ...
        return c ? "dddd" === b ? (e = je.call(this._weekdaysParse, g), e !== -1 ? e : null) : "ddd" === b ? (e = je.call(this._shortWeekdaysParse, g), 
        e !== -1 ? e : null) : (e = je.call(this._minWeekdaysParse, g), e !== -1 ? e : null) : "dddd" === b ? (e = je.call(this._weekdaysParse, g), 
        e !== -1 ? e : (e = je.call(this._shortWeekdaysParse, g), e !== -1 ? e : (e = je.call(this._minWeekdaysParse, g), 
        e !== -1 ? e : null))) : "ddd" === b ? (e = je.call(this._shortWeekdaysParse, g), 
        e !== -1 ? e : (e = je.call(this._weekdaysParse, g), e !== -1 ? e : (e = je.call(this._minWeekdaysParse, g), 
        e !== -1 ? e : null))) : (e = je.call(this._minWeekdaysParse, g), e !== -1 ? e : (e = je.call(this._weekdaysParse, g), 
        e !== -1 ? e : (e = je.call(this._shortWeekdaysParse, g), e !== -1 ? e : null)));
    }
    function Ja(a, b, c) {
        var d, e, f;
    ...
    function Na(a) {
        return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysStrictRegex : this._weekdaysRegex) : (i(this, "_weekdaysRegex") || (this._weekdaysRegex = ue), 
        this._weekdaysStrictRegex && a ? this._weekdaysStrictRegex : this._weekdaysRegex);
    }
    function Oa(a) {
        return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (i(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = ve), 
        this._weekdaysShortStrictRegex && a ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
    }
    function Pa(a) {
        return this._weekdaysParseExact ? (i(this, "_weekdaysRegex") || Qa.call(this), a ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (i(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = we), 
    ...
    function _a(a, b) {
        if (null !== b) {
            var c = Ae;
            if (b.abbr = a, null != Be[a]) y("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), 
            c = Be[a]._config; else if (null != b.parentLocale) {
                if (null == Be[b.parentLocale]) return Ce[b.parentLocale] || (Ce[b.parentLocale] = []), 
    ...
    function ab(a, b) {
        if (null != b) {
            var c, d = Ae;
            null != Be[a] && (d = Be[a]._config), b = B(d, b), c = new C(b), c.parentLocale = Be[a], 
            Be[a] = c, $a(a);
    ...
    function db(a) {
        ...
        m(a)._overflowDayOfYear && (b < ae || b > ce) && (b = ce), m(a)._overflowWeeks && b === -1 && (b = he), 
        m(a)._overflowWeekday && b === -1 && (b = ie), m(a).overflow = b), a;
    }
    function eb(a) {
    ...
    function ib(a) {
        var b, c, d, e, f = [];
        if (!a._d) {
            for (d = hb(a), a._w && null == a._a[ce] && null == a._a[be] && jb(a), a._dayOfYear && (e = gb(a._a[ae], d[ae]), 
            a._dayOfYear > pa(e) && (m(a)._overflowDayOfYear = !0), c = ta(e, 0, a._dayOfYear), 
            a._a[be] = c.getUTCMonth(), a._a[ce] = c.getUTCDate()), b = 0; b < 3 && null == a._a[b]; ++b) a._a[b] = f[b] = d[b];
            for (;b < 7; b++) a._a[b] = f[b] = null == a._a[b] ? 2 === b ? 1 : 0 : a._a[b];
            24 === a._a[de] && 0 === a._a[ee] && 0 === a._a[fe] && 0 === a._a[ge] && (a._nextDay = !0, 
            a._a[de] = 0), a._d = (a._useUTC ? ta : sa).apply(null, f), null != a._tzm && a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm), 
            a._nextDay && (a._a[de] = 24);
        }
    }
    function jb(a) {
        var b, c, d, e, f, g, h, i;
        if (b = a._w, null != b.GG || null != b.W || null != b.E) f = 1, g = 4, c = gb(b.GG, a._a[ae], wa(sb(), 1, 4).year), 
        d = gb(b.W, 1), e = gb(b.E, 1), (e < 1 || e > 7) && (i = !0); else {
            f = a._locale._week.dow, g = a._locale._week.doy;
            var j = wa(sb(), f, g);
            c = gb(b.gg, a._a[ae], j.year), d = gb(b.w, j.week), null != b.d ? (e = b.d, (e < 0 || e > 6) && (i = !0)) : null != b.e ? (e = b.e + f, 
            (b.e < 0 || b.e > 6) && (i = !0)) : e = f;
        }
        d < 1 || d > xa(c, f, g) ? m(a)._overflowWeeks = !0 : null != i ? m(a)._overflowWeekday = !0 : (h = va(c, d, e, f, g), 
        a._a[ae] = h.year, a._dayOfYear = h.dayOfYear);
    }
    function kb(b) {
        if (b._f === a.ISO_8601) return void eb(b);
        b._a = [], m(b).empty = !0;
        var c, d, e, f, g, h = "" + b._i, i = h.length, j = 0;
        for (e = Y(b._f, b._locale).match(Fd) || [], c = 0; c < e.length; c++) f = e[c], 
        d = (h.match($(f, b)) || [])[0], d && (g = h.substr(0, h.indexOf(d)), g.length > 0 && m(b).unusedInput.push(g), 
        ...
        m(b).charsLeftOver = i - j, h.length > 0 && m(b).unusedInput.push(h), b._a[de] <= 12 && m(b).bigHour === !0 && b._a[de] > 0 && (m(b).bigHour = void 0), 
        m(b).parsedDateParts = b._a.slice(0), m(b).meridiem = b._meridiem, b._a[de] = lb(b._locale, b._a[de], b._meridiem), 
        ib(b), db(b);
    }
    function lb(a, b, c) {
        var d;
    ...
    function pb(a) {
        ...
        return a._locale = a._locale || bb(a._l), null === b || void 0 === d && "" === b ? o({
            nullInput: !0
        }) : ("string" == typeof b && (a._i = b = a._locale.preparse(b)), s(b) ? new r(db(b)) : (g(b) ? a._d = b : c(d) ? mb(a) : d ? kb(a) : qb(a), 
        n(a) || (a._d = null), a));
    }
    function qb(b) {
        var d = b._i;
        void 0 === d ? b._d = new Date(a.now()) : g(d) ? b._d = new Date(d.valueOf()) : "string" == typeof d ? fb(b) : c(d) ? (b._a = h(d.slice(0), function(a) {
            return parseInt(a, 10);
        }), ib(b)) : "object" == typeof d ? nb(b) : f(d) ? b._d = new Date(d) : a.createFromInputFallback(b);
    }
    ...
    function Bb(b, c) {
        var d, e;
        return c._isUTC ? (d = c.clone(), e = (s(b) || g(b) ? b.valueOf() : sb(b).valueOf()) - d.valueOf(), 
    ...
    function Db(b, c) {
        ...
        if (null != b) {
            ...
            } else Math.abs(b) < 16 && (b *= 60);
            return !this._isUTC && c && (d = Cb(this)), this._offset = b, this._isUTC = !0, 
            null != d && this.add(d, "m"), e !== b && (!c || this._changeInProgress ? Tb(this, Ob(b - e, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, 
    ...
    function Gb(a) {
        return this._isUTC && (this.utcOffset(0, a), this._isUTC = !1, a && this.subtract(Cb(this), "m")), 
        this;
    }
    function Hb() {
    ...
    function Ob(a, b) {
        ...
        return xb(a) ? g = {
            ...
            d: a._days,
            M: a._months
        } : f(a) ? (g = {}, b ? g[b] = a : g.milliseconds = a) : (h = Ne.exec(a)) ? (c = "-" === h[1] ? -1 : 1, 
        g = {
            y: 0,
            d: u(h[ce]) * c,
            h: u(h[de]) * c,
        ...
        g = {}, g.ms = e.milliseconds, g.M = e.months), d = new wb(g), xb(a) && i(a, "_locale") && (d._locale = a._locale), 
        d;
    }
    function Pb(a, b) {
    ...
    function Rb(a, b) {
        var c;
        return a.isValid() && b.isValid() ? (b = Bb(b, a), a.isBefore(b) ? c = Qb(a, b) : (c = Qb(b, a), 
    ...
    function Sb(a, b) {
        return function(c, d) {
            ...
            f = c, c = d, d = f), c = "string" == typeof c ? +c : c, e = Ob(c, d), Tb(this, e, a), 
            this;
        };
    }
    function Tb(b, c, d, e) {
    ...
    function bc(a, b, c) {
        var d, e, f, g;
        return this.isValid() ? (d = Bb(a, this), d.isValid() ? (e = 6e4 * (d.utcOffset() - this.utcOffset()), 
        b = K(b), "year" === b || "month" === b || "quarter" === b ? (g = cc(this, d), "quarter" === b ? g /= 3 : "year" === b && (g /= 12)) : (f = this - d, 
    ...
    function _c() {
        ...
        i.minutes = b % 60, c = t(b / 60), i.hours = c % 24, g += t(c / 24), e = t(ad(g)), 
        h += e, g -= $c(bd(e)), d = t(h / 12), h %= 12, i.days = g, i.months = h, i.years = d, 
        this;
    }
    function ad(a) {
    ...
    function cd(a) {
        ...
        c = this._months + ad(b), "month" === a ? c : c / 12;
    ...
    }), J("month", "M"), M("month", 8), Z("M", Od), Z("MM", Od, Kd), Z("MMM", function(a, b) {
    ...
    J("year", "y"), M("year", 1), Z("Y", Vd), Z("YY", Od, Kd), Z("YYYY", Sd, Md), Z("YYYYY", Td, Nd), 
    Z("YYYYYY", Td, Nd), ba([ "YYYYY", "YYYYYY" ], ae), ba("YYYY", function(b, c) {
    ...
    J("isoWeek", "W"), M("week", 5), M("isoWeek", 5), Z("w", Od), Z("ww", Od, Kd), Z("W", Od), 
    Z("WW", Od, Kd), ca([ "w", "ww", "W", "WW" ], function(a, b, c, d) {
        b[d.substr(0, 1)] = u(a);
    });
    var qe = {
        dow: 0,
    ...
    J("isoWeekday", "E"), M("day", 11), M("weekday", 11), M("isoWeekday", 11), Z("d", Od), 
    Z("e", Od), Z("E", Od), Z("dd", function(a, b) {
    ...
    Z("H", Od), Z("h", Od), Z("HH", Od, Kd), Z("hh", Od, Kd), Z("hmm", Pd), Z("hmmss", Qd), 
    Z("Hmm", Pd), Z("Hmmss", Qd), ba([ "H", "HH" ], de), ba([ "a", "A" ], function(a, b, c) {
    ...
    zb("Z", ":"), zb("ZZ", ""), Z("Z", Xd), Z("ZZ", Xd), ba([ "Z", "ZZ" ], function(a, b, c) {
    ...
    }), zc("gggg", "weekYear"), zc("ggggg", "weekYear"), zc("GGGG", "isoWeekYear"), 
    zc("GGGGG", "isoWeekYear"), J("weekYear", "gg"), J("isoWeekYear", "GG"), M("weekYear", 1), 
    M("isoWeekYear", 1), Z("G", Vd), Z("g", Vd), Z("GG", Od, Kd), Z("gg", Od, Kd), Z("GGGG", Sd, Md), 
    Z("gggg", Sd, Md), Z("GGGGG", Td, Nd), Z("ggggg", Td, Nd), ca([ "gggg", "ggggg", "GGGG", "GGGGG" ], function(a, b, c, d) {
        b[d.substr(0, 2)] = u(a);
    }), ca([ "gg", "GG" ], function(b, c, d, e) {
        c[e] = a.parseTwoDigitYear(b);
    }), U("Q", 0, "Qo", "quarter"), J("quarter", "Q"), M("quarter", 7), Z("Q", Jd), 
    ba("Q", function(a, b) {
        b[be] = 3 * (u(a) - 1);
    }), U("D", [ "DD", 2 ], "Do", "date"), J("date", "D"), M("date", 9), Z("D", Od), 
    Z("DD", Od, Kd), Z("Do", function(a, b) {
    ...
    Z("DDD", Rd), Z("DDDD", Ld), ba([ "DDD", "DDDD" ], function(a, b, c) {
        c._dayOfYear = u(a);
    }), U("m", [ "mm", 2 ], 0, "minute"), J("minute", "m"), M("minute", 14), Z("m", Od), 
    Z("mm", Od, Kd), ba([ "m", "mm" ], ee);
    var Te = O("Minutes", !1);
    U("s", [ "ss", 2 ], 0, "second"), J("second", "s"), M("second", 15), Z("s", Od), 
    Z("ss", Od, Kd), ba([ "s", "ss" ], fe);
    var Ue = O("Seconds", !1);
    U("S", 0, 0, function() {
    ...
    }), J("millisecond", "ms"), M("millisecond", 16), Z("S", Rd, Jd), Z("SS", Rd, Kd), 
    Z("SSS", Rd, Ld);
    var Ve;
    ...
    var Xe = r.prototype;
    Xe.add = Pe, Xe.calendar = Vb, Xe.clone = Wb, Xe.diff = bc, Xe.endOf = oc, Xe.format = gc, 
    Xe.from = hc, Xe.fromNow = ic, Xe.to = jc, Xe.toNow = kc, Xe.get = R, Xe.invalidAt = xc, 
    Xe.isAfter = Xb, Xe.isBefore = Yb, Xe.isBetween = Zb, Xe.isSame = $b, Xe.isSameOrAfter = _b, 
    Xe.isSameOrBefore = ac, Xe.isValid = vc, Xe.lang = Re, Xe.locale = lc, Xe.localeData = mc, 
    Xe.max = Ke, Xe.min = Je, Xe.parsingFlags = wc, Xe.set = S, Xe.startOf = nc, Xe.subtract = Qe, 
    Xe.toArray = sc, Xe.toObject = tc, Xe.toDate = rc, Xe.toISOString = ec, Xe.inspect = fc, 
    Xe.toJSON = uc, Xe.toString = dc, Xe.unix = qc, Xe.valueOf = pc, Xe.creationData = yc, 
    Xe.year = pe, Xe.isLeapYear = ra, Xe.weekYear = Ac, Xe.isoWeekYear = Bc, Xe.quarter = Xe.quarters = Gc, 
    Xe.month = ka, Xe.daysInMonth = la, Xe.week = Xe.weeks = Ba, Xe.isoWeek = Xe.isoWeeks = Ca, 
    Xe.weeksInYear = Dc, Xe.isoWeeksInYear = Cc, Xe.date = Se, Xe.day = Xe.days = Ka, 
    Xe.weekday = La, Xe.isoWeekday = Ma, Xe.dayOfYear = Hc, Xe.hour = Xe.hours = ze, 
    Xe.minute = Xe.minutes = Te, Xe.second = Xe.seconds = Ue, Xe.millisecond = Xe.milliseconds = We, 
    Xe.utcOffset = Db, Xe.utc = Fb, Xe.local = Gb, Xe.parseZone = Hb, Xe.hasAlignedHourOffset = Ib, 
    Xe.isDST = Jb, Xe.isLocal = Lb, Xe.isUtcOffset = Mb, Xe.isUtc = Nb, Xe.isUTC = Nb, 
    Xe.zoneAbbr = Jc, Xe.zoneName = Kc, Xe.dates = x("dates accessor is deprecated. Use date instead.", Se), 
    Xe.months = x("months accessor is deprecated. Use month instead", ka), Xe.years = x("years accessor is deprecated. Use year instead", pe), 
    ...
    var Ye = C.prototype;
    Ye.calendar = D, Ye.longDateFormat = E, Ye.invalidDate = F, Ye.ordinal = G, Ye.preparse = Nc, 
    Ye.postformat = Nc, Ye.relativeTime = H, Ye.pastFuture = I, Ye.set = A, Ye.months = fa, 
    Ye.monthsShort = ga, Ye.monthsParse = ia, Ye.monthsRegex = na, Ye.monthsShortRegex = ma, 
    Ye.week = ya, Ye.firstDayOfYear = Aa, Ye.firstDayOfWeek = za, Ye.weekdays = Fa, 
    Ye.weekdaysMin = Ha, Ye.weekdaysShort = Ga, Ye.weekdaysParse = Ja, Ye.weekdaysRegex = Na, 
    Ye.weekdaysShortRegex = Oa, Ye.weekdaysMinRegex = Pa, Ye.isPM = Va, Ye.meridiem = Wa, 
    $a("en", {
    ...
    return rf.abs = Wc, rf.add = Yc, rf.subtract = Zc, rf.as = cd, rf.asMilliseconds = $e, 
    rf.asSeconds = _e, rf.asMinutes = af, rf.asHours = bf, rf.asDays = cf, rf.asWeeks = df, 
    rf.asMonths = ef, rf.asYears = ff, rf.valueOf = dd, rf._bubble = _c, rf.get = fd, 
    rf.milliseconds = gf, rf.seconds = hf, rf.minutes = jf, rf.hours = kf, rf.days = lf, 
    rf.weeks = hd, rf.months = mf, rf.years = nf, rf.humanize = md, rf.toISOString = nd, 
    rf.toString = nd, rf.toJSON = nd, rf.locale = lc, rf.localeData = mc, rf.toIsoString = x("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", nd), 
    rf.lang = Re, U("X", 0, 0, "unix"), U("x", 0, 0, "valueOf"), Z("x", Vd), Z("X", Yd), 
    ba("X", function(a, b, c) {
        c._d = new Date(1e3 * parseFloat(a, 10));
    }), ba("x", function(a, b, c) {
        c._d = new Date(u(a));
    }), a.version = "2.16.0", b(sb), a.fn = Xe, a.min = ub, a.max = vb, a.now = Le, 
    a.utc = k, a.unix = Lc, a.months = Rc, a.isDate = g, a.locale = $a, a.invalid = o, 
    a.duration = Ob, a.isMoment = s, a.weekdays = Tc, a.parseZone = Mc, a.localeData = bb, 
    a.isDuration = xb, a.monthsShort = Sc, a.weekdaysMin = Vc, a.defineLocale = _a, 
    a.updateLocale = ab, a.locales = cb, a.weekdaysShort = Uc, a.normalizeUnits = K, 
    a.relativeTimeRounding = kd, a.relativeTimeThreshold = ld, a.calendarFormat = Ub, 
    a.prototype = Xe, a;
}), !function(a) {
    function b(a, b, c) {
        if (8 == j) {
            var d = o.width(), e = h.debounce(function() {
                var a = o.width();
                d != a && (d = a, c());
            }, a);
            o.on(b, e);
        } else o.on(b, h.debounce(c, a));
    }
    function c(a) {
        window && window.console && window.console.log && window.console.log("jQuery.floatThead: " + a);
    }
    function d(a) {
    ...
    a.fn.floatThead = function(k) {
        ...
        return this.filter(":not(." + s.floatTableClass + ")").each(function() {
            function c(a) {
                return a + ".fth-" + D + ".floatTHead";
            }
            function k() {
                var b = 0;
                if (F.children("tr:visible").each(function() {
                    b += a(this).outerHeight(!0);
                }), "collapse" == E.css("border-collapse")) {
                    var c = parseInt(E.css("border-top-width"), 10), d = parseInt(E.find("thead tr:first").find(">*:first").css("border-top-width"), 10);
                    c > d && (b -= c / 2);
                }
                eb.outerHeight(b), fb.outerHeight(b);
            }
            function m() {
                var a = g(E, ib, !0), b = N.width() || a, c = "hidden" != N.css("overflow-y") ? b - K.vertical : b;
                if (bb.width(c), O) {
                    var d = 100 * a / c;
                    X.css("width", d + "%");
                } else X.outerWidth(a);
            ...
            function q() {
                H = (h.isFunction(s.scrollingTop) ? s.scrollingTop(E) : s.scrollingTop) || 0, I = (h.isFunction(s.scrollingBottom) ? s.scrollingBottom(E) : s.scrollingBottom) || 0;
            }
            function r() {
                var b, c;
                if ($) b = Z.find("col").length; else {
                    var d;
                    if (d = null == s.cellTag && s.headerCellSelector ? s.headerCellSelector : "tr:first>" + s.cellTag, 
                    h.isNumber(d)) return d;
                    c = F.find(d), b = 0, c.each(function() {
                        b += parseInt(a(this).attr("colspan") || 1, 10);
                    });
                }
                if (b != M) {
                    M = b;
                    for (var e, f = [], g = [], i = [], j = 0; b > j; j++) f.push(s.enableAria && (e = c.eq(j).text()) ? '<th scope="col" class="floatThead-col">' + e + "</th>" : '<th class="floatThead-col"/>'), 
                    g.push("<col/>"), i.push("<fthtd style='display:table-cell;height:0;width:auto;'/>");
                    g = g.join(""), f = f.join(""), n && (i = i.join(""), ab.html(i), ib = ab.find("fthtd")), 
                    eb.html(f), fb = eb.find("th"), $ || Z.html(g), gb = Z.find("col"), Y.html(g), hb = Y.find("col");
                }
                return b;
            }
            function t() {
                if (!J) {
                    if (J = !0, P) {
                        var a = g(E, ib, !0), b = V.width();
                        a > b && E.css("minWidth", a);
                    }
                    E.css(lb), X.css(lb), X.append(F), G.before(db), k();
                }
            }
            function u() {
                J && (J = !1, P && E.width(nb), db.detach(), E.prepend(F), E.css(mb), X.css(mb), 
                E.css("minWidth", ob), E.css("minWidth", g(E, ib)));
            }
            function v(a) {
                pb != a && (pb = a, E.triggerHandler("floatThead", [ a, bb ]));
            }
            function w(a) {
                P != a && (P = a, bb.css({
            ...
            function y() {
                ...
                return function() {
                    ...
                    var c = x(E, gb, ib, j);
                    if (c.length == b && b > 0) {
                        if (!$) for (a = 0; b > a; a++) gb.eq(a).css("width", "");
                        u();
                        var e = [];
                        for (a = 0; b > a; a++) e[a] = d(c.get(a));
                        for (a = 0; b > a; a++) hb.eq(a).width(e[a]), gb.eq(a).width(e[a]);
                        t();
                    } else X.append(F), E.css(mb), X.css(mb), k();
                };
            }
            function z(a) {
                var b = N.css("border-" + a + "-width"), c = 0;
                return b && ~b.indexOf("px") && (c = parseInt(b, 10)), c;
            }
            function A() {
                var a, b = N.scrollTop(), c = 0, d = R ? Q.outerHeight(!0) : 0, e = S ? d : -d, f = bb.height(), g = E.offset(), h = 0, i = 0;
                if (O) {
                    var j = N.offset();
                    c = g.top - j.top + b, R && S && (c += d), h = z("left"), i = z("top"), c -= i;
                } else a = g.top - H - f + I + K.horizontal;
                var k = o.scrollTop(), m = o.scrollLeft(), n = N.scrollLeft();
                return function(j) {
                    var p = E[0].offsetWidth <= 0 && E[0].offsetHeight <= 0;
                    if (!p && cb) return cb = !1, setTimeout(function() {
                        E.triggerHandler("reflow");
                    }, 1), null;
                    if (p && (cb = !0, !P)) return null;
                    if ("windowScroll" == j ? (k = o.scrollTop(), m = o.scrollLeft()) : "containerScroll" == j ? (b = N.scrollTop(), 
                    n = N.scrollLeft()) : "init" != j && (k = o.scrollTop(), m = o.scrollLeft(), b = N.scrollTop(), 
                    n = N.scrollLeft()), !l || !(0 > k || 0 > m)) {
                        if (W) w("windowScrollDone" == j); else if ("windowScrollDone" == j) return null;
                        g = E.offset(), R && S && (g.top += d);
                        var q, r, s = E.outerHeight();
                        if (O && P) {
                            if (c >= b) {
                                var x = c - b + i;
                                q = x > 0 ? x : 0, v(!1);
                            ...
                            r = h;
                        } else !O && P ? (k > a + s + e ? q = s - f + e : g.top >= k + H ? (q = 0, u(), 
                        v(!1)) : (q = H + k - g.top + c + (S ? d : 0), t(), v(!0)), r = 0) : O && !P ? (c > b || b - c > s ? (q = g.top - k, 
                        u(), v(!1)) : (q = g.top + b - k - c, t(), v(!0)), r = g.left + n - m) : O || P || (k > a + s + e ? q = s + H - k + a + e : g.top > k + H ? (q = g.top - k, 
                        t(), v(!1)) : (q = H, v(!0)), r = g.left - m);
                        return {
                            top: q,
                            left: r
                        };
            ...
            function B() {
                ...
                return function(d, e, f) {
                    null == d || a == d.top && b == d.left || (bb.css({
                        top: d.top,
                        left: d.left
                    }), a = d.top, b = d.left), e && m(), f && k();
                    var g = N.scrollLeft();
                    P && c == g || (bb.scrollLeft(g), c = g);
                };
            }
            function C() {
                if (N.length) if (N.data().perfectScrollbar) K = {
                    horizontal: 0,
                    vertical: 0
                }; else {
                    var a = N.width(), b = N.height(), c = E.height(), d = g(E, ib), e = d > a ? L : 0, f = c > b ? L : 0;
                    K.horizontal = d > a - f ? L : 0, K.vertical = c > b - e ? L : 0;
                }
            }
            var D = h.uniqueId(), E = a(this);
            if (E.data("floatThead-attached")) return !0;
            if (!E.is("table")) throw new Error('jQuery.floatThead must be run on a table element. ex: $("table").floatThead();');
            i = s.autoReflow && i;
            var F = E.children("thead:first"), G = E.children("tbody:first");
            if (0 == F.length || 0 == G.length) return E.data("floatThead-lazy", s), void E.unbind("reflow").one("reflow", function() {
                E.floatThead(s);
            });
            E.data("floatThead-lazy") && E.unbind("reflow"), E.data("floatThead-lazy", !1);
            var H, I, J = !1, K = {
                vertical: 0,
                horizontal: 0
            }, L = e(), M = 0, N = s.scrollContainer(E) || a([]), O = N.length > 0, P = s.useAbsolutePositioning;
            null == P && (P = O), P || (J = !0);
            var Q = E.find("caption"), R = 1 == Q.length;
            if (R) var S = "top" === (Q.css("caption-side") || Q.attr("align") || "top");
            var T = a('<fthfoot style="display:table-footer-group;border-spacing:0;height:0;border-collapse:collapse;"/>'), U = !1, V = a([]), W = 9 >= j && !O && P, X = a("<table/>"), Y = a("<colgroup/>"), Z = E.children("colgroup:first"), $ = !0;
            0 == Z.length && (Z = a("<colgroup/>"), $ = !1);
            var ab = a('<fthtr style="display:table-row;border-spacing:0;height:0;border-collapse:collapse"/>'), bb = a('<div style="overflow: hidden;" aria-hidden="true" class="floatThead-floatContainer"></div>'), cb = !1, db = a("<thead/>"), eb = a('<tr class="size-row"/>'), fb = a([]), gb = a([]), hb = a([]), ib = a([]);
            db.append(eb), E.prepend(Z), n && (T.append(ab), E.append(T)), X.append(Y), bb.append(X), 
            s.copyTableClass && X.attr("class", E.attr("class")), X.attr({
                cellpadding: E.attr("cellpadding"),
                cellspacing: E.attr("cellspacing"),
                border: E.attr("border")
            });
            var jb = E.css("display");
            if (X.css({
                borderCollapse: E.css("borderCollapse"),
                border: E.css("border"),
                display: jb
            }), "none" == jb && (cb = !0), X.addClass(s.floatTableClass).css({
                margin: 0,
                ...
                var kb = function(a, b) {
                    ...
                    if (!d || b) {
                        ...
                        bb.css(e), a = a.wrap("<div class='" + s.floatWrapperClass + "' style='position: relative; clear:both;'></div>").parent(), 
                        U = !0;
                    }
                    return a;
                };
                O ? (V = kb(N, !0), V.append(bb)) : (V = kb(E), E.after(bb));
            } else E.after(bb);
            bb.css({
                position: P ? "absolute" : "fixed",
                marginTop: 0,
                top: P ? 0 : "auto",
                zIndex: s.zIndex
            }), bb.addClass(s.floatContainerClass), q();
            var lb = {
                "table-layout": "fixed"
            }, mb = {
                "table-layout": E.css("tableLayout") || "auto"
            }, nb = E[0].style.width || "", ob = E.css("minWidth") || "", pb = !1;
            C();
            var qb, rb = function() {
                (qb = y())();
            };
            ...
            var ub = h.debounce(function() {
                ...
                tb(sb("windowScroll"), !1), W && ub();
            }, wb = function() {
                tb(sb("containerScroll"), !1);
            }, xb = function() {
                E.is(":hidden") || (q(), C(), rb(), sb = A(), (tb = B())(sb("resize"), !0, !0));
            }, yb = h.debounce(function() {
                E.is(":hidden") || (C(), q(), rb(), sb = A(), tb(sb("reflow"), !0));
            }, 1);
            if (O ? P ? N.on(c("scroll"), wb) : (N.on(c("scroll"), wb), o.on(c("scroll"), vb)) : o.on(c("scroll"), vb), 
            o.on(c("load"), yb), b(s.debounceResizeMs, c("resize"), xb), E.on("reflow", yb), 
            f(E) && E.on("filter", yb).on("sort", yb).on("page", yb), o.on(c("shown.bs.tab"), yb), 
            o.on(c("tabsactivate"), yb), i) {
                var zb = null;
                _.isFunction(s.autoReflow) && (zb = s.autoReflow(E, N)), zb || (zb = N.length ? N[0] : E[0]), 
                p = new MutationObserver(function(a) {
            ...
            E.data("floatThead-attached", {
                destroy: function() {
                    var a = ".fth-" + D;
                    u(), E.css(mb), Z.remove(), n && T.remove(), db.parent().length && db.replaceWith(F), 
                    i && (p.disconnect(), p = null), E.off("reflow"), N.off(a), U && (N.length ? N.unwrap() : E.unwrap()), 
                    E.css("minWidth", ob), bb.remove(), E.data("floatThead-attached", !1), o.off(a);
                },
                reflow: function() {
                    yb();
                },
                ...
                getRowGroups: function() {
                    return J ? bb.children("thead").add(E.children("tbody,tfoot")) : E.children("thead,tbody,tfoot");
                }
            });
        }), this;
    };
...
function() {
    function floatThead($timeout, $log) {
        function link($scope, $element, $attrs, ngModel) {
            $scope.$watch("floatTheadEnabled", function(newVal) {
                newVal === !0 ? angular.isObject($scope.floatThead) && jQuery($element).floatThead($scope.floatThead) : jQuery($element).floatThead("destroy");
            }), $scope.$watch("floatThead", function(newVal, oldVal) {
                newVal !== oldVal && $scope.floatTheadEnabled && (jQuery($element).floatThead("destroy"), 
                angular.isObject(newVal) && jQuery($element).floatThead(newVal));
            }, !0), ngModel ? ngModel.$formatters.push(function() {
                $scope.floatTheadEnabled && angular.isObject($scope.floatThead) && $timeout(function() {
                    jQuery($element).floatThead("reflow");
                });
            }) : $log.info("floatThead: ngModel not provided!"), $element.bind("update", function() {
                $timeout(function() {
                    jQuery($element).floatThead("reflow");
                }, 0);
        ...
        var directive = {
            ...
            controller: [ "$scope", "$element", "$attrs", function($scope, $element, $attrs) {
                $attrs.hasOwnProperty("floatTheadEnabled") || ($scope.floatTheadEnabled = $attrs.floatTheadEnabled = !0), 
                $attrs.hasOwnProperty("floatThead") && "" !== $attrs.floatThead || ($scope.floatThead = $attrs.floatThead = {});
            } ],
            link: link,
            restrict: "A"
        };
    ...
    m.each = m.forEach = function(n, t, r) {
        ...
        var e;
        return e = k(n) ? m.findIndex(n, t, r) : m.findKey(n, t, r), void 0 !== e && e !== -1 ? n[e] : void 0;
...
}.call(this), angular.module("ui.autocomplete", []).directive("uiAutocomplete", [ "$timeout", "$exceptionHandler", function($timeout, $exceptionHandler) {
    ...
    var proto = $.ui.autocomplete.prototype, initSource = proto._initSource, slice = Array.prototype.slice;
    return $.extend(proto, {
        _initSource: function() {
        ...
        _normalize: function(items) {
            return $.map(items, function(item) {
                return item && "object" == typeof item ? $.extend({
        ...
        _renderItemData: function(ul, item) {
            ...
            return item.groupLabel ? element = $("<div>").append(element).addClass("ui-menu-group") : this.options.html ? ("object" == typeof element && (element = $(element)), 
            ("object" != typeof element || element.length > 1 || !element.is("a")) && (element = $("<a>").append(element))) : element = $("<a>").text(element), 
            $("<li>").append(element).appendTo(ul).data("ui-autocomplete-item", item);
        },
        _resizeMenu: function() {
            var that = this;
            setTimeout(function() {
                var ul = that.menu.element, maxHeight = ul.css("max-height") || 0, width = Math.max(ul.width("").outerWidth() + 1, that.element.outerWidth()), height = (that.element.height(), 
                $(window).height() - that.options.outHeight - ul.offset().top);
                height = maxHeight && height > maxHeight ? maxHeight : height, ul.css({
                    width: width,
                    maxHeight: height
                });
            }, 10);
        ...
        link: function(scope, element, attr, ctrl) {
            function changeNgModel(data) {
                isObject(ngModel) && (ctrl.$viewValue || 0 === ctrl.$viewValue ? data && data.item && (data.item.label = isObject(data.item.label) ? $("<div>").append(data.item.label).html() : data.item.label, 
                extend(ngModel, data.item)) : emptyObj(ngModel), each(ctrl.$viewChangeListeners, function(listener) {
                    try {
                        listener();
                    } catch (e) {
                        $exceptionHandler(e);
            ...
            function cleanNgModel() {
                ctrl.$setViewValue(""), ctrl.$render(), changeNgModel();
            }
            function autoFocusHandler() {
                autocomplete.options.focusOpen && !status && element.autocomplete("search", "");
            }
            function checkOptions(options) {
                return options = isObject(options) ? options : {}, options.disabled = !options.source || options.disabled, 
                options.appendTo = options.appendTo || element.parents(".ng-view")[0] || element.parents("[ng-view]")[0] || null, 
                options.minLength = options.focusOpen ? 0 : options.minLength, options.outHeight = options.outHeight || 0, 
            ...
            function emptyObj(a) {
                if (isObject(a)) {
                    ...
                    each(a, function(value, key) {
                        ...
                        reg.test(key) || ("number" === type ? a[key] = 0 : "string" === type ? a[key] = "" : "boolean" === type ? a[key] = !1 : isObject(value) && emptyObj(value));
                    });
                }
            }
            var status = !1, selectItem = null, events = {}, ngModel = null, each = angular.forEach, isObject = angular.isObject, extend = angular.extend, autocomplete = scope.$eval(attr.uiAutocomplete), valueMethod = angular.bind(element, element.val), methodsName = [ "close", "destroy", "disable", "enable", "instance", "option", "search", "widget" ], eventsName = [ "change", "close", "create", "focus", "open", "response", "search", "select" ], unregisterWatchModel = scope.$watch(attr.ngModel, function(value) {
                ngModel = value, isObject(ngModel) && (ctrl.$formatters.push(function(obj) {
                    return obj.value;
                }), ctrl.$parsers.push(function(value) {
                    return ngModel.value = value, ngModel;
                }), scope.$watch(attr.ngModel, function(model) {
                    valueMethod() !== model.value && (ctrl.$viewValue = model.value, ctrl.$render());
                }, !0), ctrl.$pristine = !1, ctrl.$setViewValue(ngModel.value), ctrl.$pristine = !0), 
                value && unregisterWatchModel();
            }), uiEvents = {
                open: function(event, ui) {
                    status = !0, selectItem = null;
                },
                close: function(event, ui) {
                    status = !1;
                },
                select: function(event, ui) {
                    selectItem = ui, $timeout(function() {
                        element.blur();
                    }, 0);
                },
                change: function(event, ui) {
                    var value = valueMethod(), selected = !1;
                    selectItem && selectItem.item && value.indexOf(selectItem.item.value) !== -1 && (value = selectItem.item.value, 
                    selected = !0), scope.$apply(function() {
                        autocomplete.options.onlySelectValid && ctrl.$setValidity("onlyselect", selected), 
                        null === value ? ctrl.$render() : "" === value ? changeNgModel() : ctrl.$viewValue !== value && (ctrl.$setViewValue(value), 
                        ctrl.$render(), changeNgModel(selectItem));
                    });
                }
            };
            isObject(autocomplete) && (autocomplete.methods = {}, autocomplete.options = checkOptions(autocomplete.options), 
            each(eventsName, function(name) {
                var _event = autocomplete.options[name];
                _event = "function" == typeof _event ? _event : angular.noop, events[name] = function(event, ui) {
                    uiEvents[name] && uiEvents[name](event, ui), _event(event, ui), autocomplete.events && "function" == typeof autocomplete.events[name] && autocomplete.events[name](event, ui);
                };
            }), each(methodsName, function(name) {
                autocomplete.methods[name] = function() {
                    var args = slice.call(arguments);
                    return args.unshift(name), element.autocomplete.apply(element, args);
                };
            }), autocomplete.methods.filter = filter, autocomplete.methods.clean = cleanNgModel, 
            element.on("focus", autoFocusHandler), element.autocomplete(extend({}, autocomplete.options, events)), 
            autocomplete.widget = element.autocomplete("widget"));
        }
    };
} ]), function(window, angular, undefined) {
    var module = angular.module("nsPopover", []), $el = angular.element, isDef = angular.isDefined, $popovers = [], globalId = 0;
        ...
        return {
            ...
            link: function(scope, elm, attrs) {
                function move(popover, placement, align, rect, triangle) {
                    var top, left, popoverRect = getBoundingClientRect(popover[0]), positionX = function() {
                        return "center" === align ? Math.round(rect.left + rect.width / 2 - popoverRect.width / 2) : "right" === align ? rect.right - popoverRect.width : rect.left;
                    }, positionY = function() {
                        return "center" === align ? Math.round(rect.top + rect.height / 2 - popoverRect.height / 2) : "bottom" === align ? rect.bottom - popoverRect.height : rect.top;
                    };
                    "top" === placement ? (top = rect.top - popoverRect.height, left = positionX()) : "right" === placement ? (top = positionY(), 
                    left = rect.right) : "bottom" === placement ? (top = rect.bottom, left = positionX()) : "left" === placement && (top = positionY(), 
                    left = rect.left - popoverRect.width), popover.css("top", top.toString() + "px").css("left", left.toString() + "px"), 
                    triangle && ("top" === placement || "bottom" === placement ? (left = rect.left + rect.width / 2 - left, 
                    triangle.css("left", left.toString() + "px")) : (top = rect.top + rect.height / 2 - top, 
                ...
                function adjustRect(rect, adjustX, adjustY, ev) {
                    ...
                    return adjustX && (localRect.left = ev.pageX, localRect.right = ev.pageX, localRect.width = 0), 
                    adjustY && (localRect.top = ev.pageY, localRect.bottom = ev.pageY, localRect.height = 0), 
                    localRect;
                }
                function getBoundingClientRect(elm) {
                    var w = window, doc = document.documentElement || document.body.parentNode || document.body, x = isDef(w.pageXOffset) ? w.pageXOffset : doc.scrollLeft, y = isDef(w.pageYOffset) ? w.pageYOffset : doc.scrollTop, rect = elm.getBoundingClientRect();
                    return x || y ? {
                ...
                function loadTemplate(template, plain) {
                    return template ? angular.isString(template) && plain ? template : $templateCache.get(template) || $http.get(template, {
                        cache: !0
                    }) : "";
                }
                function insideClickHandler() {
                    $popover.isOpen && hider_.hide(0);
                }
                function outsideClickHandler(e) {
                    function isInPopover(el) {
                        if (el.id === id) return !0;
                        var parent = angular.element(el).parent()[0];
                        return !!parent && (parent.id === id || isInPopover(parent));
                    }
                    if ($popover.isOpen && e.target !== elm[0]) {
                        var id = $popover[0].id;
                        isInPopover(e.target) || hider_.hide(0);
                    }
                }
                function buttonClickHandler() {
                    $popover.isOpen && hider_.hide(0);
                }
                var defaults = nsPopover.getDefaults(), options = {
                ...
                options.mouseRelative && (options.mouseRelativeX = options.mouseRelative.indexOf("x") !== -1, 
                options.mouseRelativeY = options.mouseRelative.indexOf("y") !== -1);
                var displayer_ = {
                    id_: undefined,
                    display: function(delay, e) {
                        $parse(attrs.nsPopover)(scope) !== !1 && ($timeout.cancel(displayer_.id_), isDef(delay) || (delay = 0), 
                        options.group && $rootScope.$broadcast("ns:popover:hide", options.group), displayer_.id_ = $timeout(function() {
                            $popover.isOpen = !0, $popover.css("display", "block");
                            var elmRect = getBoundingClientRect(elm[0]);
                            options.mouseRelative && (elmRect = adjustRect(elmRect, options.mouseRelativeX, options.mouseRelativeY, e)), 
                            move($popover, placement_, align_, elmRect, $triangle), options.hideOnInsideClick && $popover.on("click", insideClickHandler), 
                            options.hideOnOutsideClick && $document.on("click", outsideClickHandler), options.hideOnButtonClick && elm.on("click", buttonClickHandler);
                        }, 1e3 * delay));
                    },
                    cancel: function() {
                    ...
                    id_: undefined,
                    hide: function(delay) {
                        $timeout.cancel(hider_.id_), "-1" !== delay && (isDef(delay) || (delay = 1.5), hider_.id_ = $timeout(function() {
                            $popover.off("click", insideClickHandler), $document.off("click", outsideClickHandler), 
                            elm.off("click", buttonClickHandler), $popover.isOpen = !1, displayer_.cancel(), 
                ...
                $container.length || ($container = $document.find("body"));
                var $triangle, placement_, align_;
                globalId += 1;
                var $popover = $el('<div id="nspopover-' + globalId + '"></div>');
                $popovers.push($popover);
                var match = options.placement.match(/^(top|bottom|left|right)$|((top|bottom)\|(center|left|right)+)|((left|right)\|(center|top|bottom)+)/);
                if (!match) throw new Error('"' + options.placement + '" is not a valid placement or has a invalid combination of placements.');
                placement_ = match[6] || match[3] || match[1], align_ = match[7] || match[4] || match[2] || "center", 
                $q.when(loadTemplate(options.template, options.plain)).then(function(template) {
                    ...
                    $popover.html(template), options.theme && $popover.addClass(options.theme), $popover.addClass("ns-popover-" + placement_ + "-placement").addClass("ns-popover-" + align_ + "-align"), 
                    $compile($popover)(scope), scope.$on("$destroy", function() {
                        $popover.remove();
                    }), scope.hidePopover = function() {
                        hider_.hide(0);
                    }, scope.$on("ns:popover:hide", function(ev, group) {
                        options.group === group && scope.hidePopover();
                    }), $popover.css("position", "absolute").css("display", "none"), $triangle = $popover[0].querySelectorAll(".triangle"), 
                    $triangle.length && ($triangle = $el($triangle)), $container.append($popover);
                }), options.angularEvent ? $rootScope.$on(options.angularEvent, function() {
                    hider_.cancel(), displayer_.display(options.popupDelay);
                }) : options.scopeEvent ? scope.$on(options.scopeEvent, function() {
                    hider_.cancel(), displayer_.display($popover, options.popupDelay);
                }) : elm.on(options.trigger, function(e) {
                    !1 !== options.triggerPrevent && e.preventDefault(), hider_.cancel(), displayer_.display(options.popupDelay, e);
