/*! ess - v - 2016-10-13 */function supplyNavigationController($scope, $location, appProps, locationService, categoryService, destinationService) {
...
function fulfillmentEditingModal($scope, appProps, modals, requisitionApi, locationAutocompleteService, itemAutocompleteService) {
    ...
    $scope.init = function() {
        ...
        $scope.editableRequisition.lineItems.push({
            item: newItem,
            quantity: 1
        }), $scope.newItemCommodityCode = "", void $scope.onUpdate()) : !1;
    ...
    return {
        ...
        link: function(scope, elm, attrs, ctrl) {
            ctrl.$validators.wholeNumber = function(modelValue, viewValue) {
                return modelValue % 1 === 0 && null !== modelValue && 3e4 > modelValue;
            };
        }
    };
