/*! ess - v - 2016-10-07 */function supplyNavigationController($scope, $location, appProps, locationService, categoryService, destinationService) {
...
function supplyFulfillmentController($scope, requisitionApi, supplyEmployeesApi, itemsApi, modals, $interval, locationService, locationStatisticsService) {
    ...
    function getSyncFailedShipments() {
        ...
        $scope.syncFailedSearch.response = requisitionApi.get(params, function(response) {
            ...
            $scope.syncFailedSearch.matches = [], $scope.syncFailedSearch.error = !0;
        });
    }
