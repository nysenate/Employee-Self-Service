/*! ess - v - 2016-09-20 */function supplyNavigationController($scope, $location, appProps, locationService, categoryService, destinationService) {
...
function supplyOrderController($scope, appProps, locationService, supplyCart, paginationModel, locationAutocompleteService, allowanceService, destinationService, modals, supplyUtils) {
    ...
    $scope.init = function() {
        ...
        return supplyCart.isItemInCart(item.id) && 1 == supplyCart.getCartLineItem(item.id).quantity;
