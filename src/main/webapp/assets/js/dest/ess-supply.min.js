...
essSupply = angular.module("essSupply").controller("SupplyReconciliationController", [ "$scope", "SupplyRequisitionApi", "LocationService", "SupplyUtils", "modals", "$window", "$timeout", supplyReconciliationController ]);
