...
function supplyFulfillmentController($scope, requisitionApi, supplyEmployeesApi, itemsApi, modals, $interval, locationService, locationStatisticsService, supplyUtils) {
    ...
    function getApprovedShipments() {
        ...
        $scope.approvedSearch.response = requisitionApi.get(params, function(response) {
            $scope.approvedSearch.matches = response.result, $scope.approvedSearch.matches = keepNewPlaceReq($scope.approvedSearch.matches), 
...
function supplyOrderController($scope, locationService, supplyCart, paginationModel, locationAutocompleteService, allowanceService, destinationService, modals, supplyUtils, lineItemService, itemFilterService, categoryService, stateService) {
    ...
    function loadShoppingState() {
        ...
        allowanceService.queryLocationAllowance(destinationService.getDestination()).then(initializeCart).then(sortAndFilterLineItems).then(setDestinationDescription).then(setToShoppingState).catch(loadItemsError);
    }
...
essSupply.factory("SupplyCategoryService", [ "SupplyLocationAllowanceService", "LocationService", supplyCategoryService ]), 
...
var essSupply = angular.module("essSupply").controller("SupplyOrderController", [ "$scope", "LocationService", "SupplyCartService", "PaginationModel", "SupplyLocationAutocompleteService", "SupplyLocationAllowanceService", "SupplyOrderDestinationService", "modals", "SupplyUtils", "SupplyLineItemService", "SupplyItemFilterService", "SupplyCategoryService", "SupplyOrderPageStateService", supplyOrderController ]);
