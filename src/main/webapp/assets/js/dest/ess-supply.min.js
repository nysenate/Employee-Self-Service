...
function supplyHistoryController($scope, supplyIssuersApi, requisitionApi, locationService, locationApi, paginationModel, supplyUtils, modals) {
...
essSupply = angular.module("essSupply").controller("SupplyHistoryController", [ "$scope", "SupplyIssuersApi", "SupplyRequisitionApi", "LocationService", "LocationApi", "PaginationModel", "SupplyUtils", "modals", supplyHistoryController ]);
