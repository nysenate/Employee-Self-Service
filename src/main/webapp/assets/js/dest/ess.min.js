    ...
    $routeProvider.when(ctxPath + "/myinfo", {
        ...
        resolve: {
            locAutocomplete: [ "SupplyLocationAllowanceService", "SupplyCookieService", function(supplyLocationAllowanceService, supplyCookieService) {
                if (null !== supplyCookieService.getDestination()) return supplyLocationAllowanceService.queryLocationAllowance(supplyCookieService.getDestination());
            } ]
        }
...
essApp.directive("modalContainer", [ "$rootScope", "$document", "modals", function($rootScope, $document, modals) {
    ...
    return {
        template: '<div id="modal-container" ng-show="top">  <div id="modal-backdrop"></div>  <div id="common-modals">    <div internal-error-modal ng-if="isOpen(\'500\')"></div>    <div timeout-modal ng-if="isOpen(\'timeout\')"></div>  </div>  <ng-transclude></ng-transclude></div>',
        transclude: !0,
        link: link
    };
