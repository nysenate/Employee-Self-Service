...
essApp.controller("MainCtrl", [ "$scope", "$http", "$route", "$routeParams", "$location", "$window", "appProps", function($scope, $http, $route, $routeParams, $location, $window, appProps) {
...
}), angular.module("ess").filter("possessive", possessiveFilter), angular.module("ess").service("promiseUtils", [ "$q", promiseUtilsService ]);
