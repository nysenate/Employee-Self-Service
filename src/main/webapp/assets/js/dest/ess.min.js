...
essApp.controller("MainCtrl", [ "$scope", "$http", "$route", "$routeParams", "$location", "$window", "appProps", "modals", function($scope, $http, $route, $routeParams, $location, $window, appProps, modals) {
