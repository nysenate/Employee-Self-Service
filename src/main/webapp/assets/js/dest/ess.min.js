/*! ess - v - 2016-10-12 */function locationService($location, $window, $anchorScroll, appProps) {
...
essCore.constant("appProps", globalProps), essCore.run([ "$cookies", function($cookies) {
    ...
    $cookies.put("appVersion", globalProps.releaseVersion), $(document).unbind("keydown").bind("keydown", function(event) {
        var doPrevent = !1;
        if (8 === event.keyCode) {
            var d = event.srcElement || event.target;
            doPrevent = "INPUT" === d.tagName.toUpperCase() && ("TEXT" === d.type.toUpperCase() || "PASSWORD" === d.type.toUpperCase() || "FILE" === d.type.toUpperCase() || "SEARCH" === d.type.toUpperCase() || "EMAIL" === d.type.toUpperCase() || "NUMBER" === d.type.toUpperCase() || "DATE" === d.type.toUpperCase()) || "TEXTAREA" === d.tagName.toUpperCase() ? d.readOnly || d.disabled : !0;
        }
    ...
    return {
        request: function(request) {
            ...
            var myvar = '<div id="timeout-confirm" title="Inactive Session Timeout">  <p style="padding-left: 35px;padding-top: 10px;"><span class="ui-icon ui-icon-alert" ></span><span style="font-size: large; align-content: center;">Due to inactivity, this session will timeout in <span id="tick">60</span> seconds. Do you want to continue your work?</span></p></div>';
