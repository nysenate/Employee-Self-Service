...
var essCore = angular.module("essCore", [ "ngCookies" ]), essApi = angular.module("essApi", [ "essCore" ]), essMyInfo = angular.module("essMyInfo", [ "essApi" ]), essTime = angular.module("essTime", [ "essApi" ]), essSupply = angular.module("essSupply", [ "essApi", "ngCookies" ]), essHelp = angular.module("essHelp", [ "essApi" ]), essApp = angular.module("ess", [ "ngRoute", "ngResource", "ngAnimate", "essMyInfo", "essTime", "essSupply", "essHelp", "floatThead", "angularUtils.directives.dirPagination", "ui.autocomplete", "nsPopover" ]);
...
} ]), angular.module("essTime").directive("progressModal", [ progressModal ]).directive("confirmModal", [ "modals", confirmModal ]);
...
essApp.directive("internalErrorModal", [ "modals", "ErrorReportApi", "appProps", function(modals, errorReportApi, appProps) {
    return {
        template: '<section id="internal-error-modal" title="Internal Error"><h1>Internal Error</h1><p class="internal-error-text">We are sorry to report that an error occurred on the ESS server while processing your request.<br>Please contact the STS Help Line at (518) 455-2011 and notify us of this issue so that we can fix it!</p><p style="color: red" ng-show="showFailure">Sorry, your report can not send now, please contact us at (518) 455-2011</p><pre class="internal-error-details" ng-show="showDetails">{{details | json}}</pre><div class="button-container"><input type="button" class="reject-button" ng-click="showDetails = !showDetails" value="{{showDetails ? \'Hide\' : \'Show\'}} Details"/><input type="button" class="reject-button" ng-click="report()" value="Report Error"/><input type="button" class="reject-button" ng-click="close()" value="OK"/></div></section>',
        link: function($scope, $element, $attrs) {
            $scope.showDetails = !1, $scope.showFailure = !1, $scope.details = modals.params().details, 
...
essApp.directive("textAutoHeight", [ "$timeout", function($timeout) {
    ...
    var isPingInitialized = !1, isTimeoutModalOpen = !1, pingRate = 30, idleTime = 0;
    return {
