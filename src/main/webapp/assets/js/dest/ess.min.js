...
essApp.filter("moment", [ "$filter", function($filter) {
    ...
    return function(input, suffix, defaultVal) {
        return suffix = suffix === !0, input ? moment(input).fromNow(suffix) : void 0 !== defaultVal ? defaultVal : "--";
    };
...
} ]), angular.module("ess").filter("zeroPad", zeroPadFilter), angular.module("ess").service("EssStorageService", [ "$window", "appProps", essStorageService ]), 
