...
var essCore = angular.module("essCore", [ "ngCookies" ]), essApi = angular.module("essApi", [ "essCore" ]), essMyInfo = angular.module("essMyInfo", [ "essApi" ]), essTime = angular.module("essTime", [ "essApi" ]), essSupply = angular.module("essSupply", [ "essApi", "ngCookies" ]), essHelp = angular.module("essHelp", [ "essApi" ]), essApp = angular.module("ess", [ "ngRoute", "ngResource", "ngAnimate", "ngSanitize", "essCore", "essMyInfo", "essTime", "essSupply", "essHelp", "floatThead", "angularUtils.directives.dirPagination", "ui.autocomplete", "nsPopover", "infinite-scroll", "jlareau.bowser" ]);
