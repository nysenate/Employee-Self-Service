...
angular.module("essTime").directive("employeeSearch", [ "appProps", "modals", "LocationService", "EmployeeSearchApi", "EmpInfoApi", "PaginationModel", "RestErrorService", function(appProps, modals, locationService, employeeSearchApi, empInfoApi, paginationModel, RestErrorService) {
    return {
        scope: {
            selectedEmp: "=?"
        },
