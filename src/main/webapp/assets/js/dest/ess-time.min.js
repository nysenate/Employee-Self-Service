...
function employeeSelectDirective(appProps, supEmpGroupService) {
    return {
        ...
        link: function($scope, $elem, $attrs) {
            ...
            $scope.selectSubject = $attrs.selectSubject, supEmpGroupService.init().then(function() {
...
function accrualHistoryDirective($timeout, appProps, modals, AccrualHistoryApi, EmpInfoApi, ActiveYearsTimeRecordsApi) {
    return {
        ...
        link: function($scope) {
            ...
            $scope.$watch("empId", getEmpActiveYears), $scope.$watch("empId", clearAccSummaries), 
            $scope.$watch("selectedYear", getAccSummaries), $scope.isUser = function() {
...
function accrualProjectionCtrl($scope, $timeout, appProps, AccrualHistoryApi, EmpInfoApi, modals, accrualUtils) {
    ...
    $scope.state = {
        ...
        var fromDate = moment([ year, 0, 1 ]).subtract(6, "months"), toDate = moment([ year + 1, 0, 1 ]);
...
angular.module("essTime").directive("accrualHistory", [ "$timeout", "appProps", "modals", "AccrualHistoryApi", "EmpInfoApi", "ActiveYearsTimeRecordsApi", accrualHistoryDirective ]);
