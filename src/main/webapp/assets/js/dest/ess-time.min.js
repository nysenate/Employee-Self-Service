...
function employeeSearchDirective(appProps, modals, employeeSearchApi, empInfoApi, paginationModel) {
    return {
        ...
        link: function($scope, $elem, $attrs) {
            ...
            function newSearch() {
                return $scope.searchResults = [], pagination.reset(), getSearchResults();
            }
            $scope.selectedEmp = null, $scope.empInfo = null, $scope.searchTerm = "", $scope.searchResults = [];
...
angular.module("essTime").directive("employeeSearch", [ "appProps", "modals", "EmployeeSearchApi", "EmpInfoApi", "PaginationModel", employeeSearchDirective ]), 
