...
function employeeSearchDirective($filter, appProps, modals, activeEmpApi) {
    return {
        ...
        link: function($scope, $elem, $attrs) {
            ...
            $scope.activeEmps = null, $scope.selectedEmp = null, $scope.search = {
                fullName: ""
    ...
    return {
        ...
        link: function($scope, $elem, $attrs) {
            ...
            $scope.state = {
                ...
                timesheetRecords: [],
                attendRecords: []
            }, $scope.$watchCollection("empSupInfo", setEmpId), $scope.$watchCollection("empSupInfo", getTimeRecordYears), 
            $scope.$watch("state.selectedRecYear", getRecords), $scope.showDetails = function(record) {
                if (!record.paperTimesheet) {
                    var params = {
                        record: record
                    };
...
} ]), angular.module("essTime").controller("EmployeeSearchCtrl", [ "$scope", employeeSearchCtrl ]), 
angular.module("essTime").directive("employeeSearch", [ "$filter", "appProps", "modals", "ActiveEmployeeApi", employeeSearchDirective ]), 
