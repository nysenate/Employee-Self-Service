...
essMyInfo.filter("formatDeductionHeader", function() {
    ...
    function acknowledgmentCtrl($scope, $routeParams, $q, $location, bowser, appProps, modals, documentApi, ackApi) {
        ...
        $scope.isLoading = function() {
            ...
            postAcknowledgment().then(function() {
    ...
    angular.module("essMyInfo").controller("AckDocViewCtrl", [ "$scope", "$routeParams", "$q", "$location", "bowser", "appProps", "modals", "AckDocApi", "AcknowledgmentApi", acknowledgmentCtrl ]);
}(), function() {
