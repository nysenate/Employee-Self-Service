...
function travelAppController($scope, $q, appProps, modals, locationService, appInitApi, purposeApi, outboundApi, returnApi, expensesApi, travelApplicationApi, motApi) {
...
essTravel.controller("NewTravelApplicationCtrl", [ "$scope", "$q", "appProps", "modals", "LocationService", "TravelApplicationInitApi", "TravelApplicationPurposeApi", "TravelApplicationOutboundApi", "TravelApplicationReturnApi", "TravelApplicationExpensesApi", "TravelApplicationApi", "TravelModeOfTransportationApi", travelAppController ]), 
