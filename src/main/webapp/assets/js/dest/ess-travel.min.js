...
function travelAppController($scope, $q, appProps, modals, locationService, appInitApi, travelApplicationApi, attachmentApi) {
    ...
    $scope.ACTIONS = {
        ...
        return $scope.appState === $scope.STATES.DESTINATION || $scope.appState === $scope.STATES.ALLOWANCES || $scope.appState === $scope.STATES.REVIEW || $scope.appState === $scope.STATES.EDIT;
...
essTravel.controller("NewTravelApplicationCtrl", [ "$scope", "$q", "appProps", "modals", "LocationService", "TravelApplicationInitApi", "TravelApplicationApi", "TravelApplicationAttachmentApi", travelAppController ]), 
    ...
    return {
        ...
        link: function($scope, $elem, $attrs) {
            $scope.destinations = angular.copy($scope.app.destinations), $scope.editDestination = function(dest) {
                ...
                modals.open("destination-delete-confirm-modal").then(function() {
                    var index = $scope.destinations.indexOf(dest);
                    $scope.destinations.splice(index, 1), $scope.setDestinations($scope.destinations);
                });
