...
function userConfigCtrl($scope, appProps, ActiveEmployeeApi, TravelUserConfigApi) {
    $scope.dataLoaded = !1, $scope.empId = appProps.user.employeeId, $scope.init = function() {
        $scope.granteeInfo = {
            ...
            return $scope.dataLoaded = !0, TravelUserConfigApi.get({
                empId: $scope.empId,
                detail: !0
            }, function(resp) {}).$promise;
        }).catch(function(resp) {
        ...
        return !($scope.granteeInfo.selectedGrantee && ($scope.granteeInfo.permanent || $scope.granteeInfo.startDate && $scope.granteeInfo.endDate));
    }, $scope.saveGrants = function() {}, $scope.setPermanent = function() {
