            ...
            vendor: {
                ...
                files: {
                    '<%= jsDest %>/ess-vendor.min.js': [
                        ...
                        '<%= bowerRoot %>/jquery-locationpicker-plugin/dist/locationpicker.jquery.min.js',
                        '<%= bowerRoot %>/jquery-locationpicker-plugin/dist/angularLocationpicker.jquery.min.js'
                        ],
