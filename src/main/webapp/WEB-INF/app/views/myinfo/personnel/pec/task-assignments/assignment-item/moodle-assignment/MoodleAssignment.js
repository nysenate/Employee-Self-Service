    ...
    <>
      ...
      <Card className="mt-5 pb-5">
        {assignment.completed ? (
          <Card.Header>
            Records indicate you completed the Introduction to Ethics training
            on or before
            {isoToLongDate(assignment.timestamp)}
          </Card.Header>
        ) : (
          <Card.Header>
            As mandated by law, all new employees are required to complete an
            interactive Ethics Orientation.
            <br />
            ...
            <ul className="mx-5 list-disc">
              ...
              <li>
                ...
                <span className="font-semibold">
                  You must use your Senate email address for account
                  registration.
                </span>
              </li>
              <li>
                The online course includes questions which all need to be
                answered correctly to proceed through the material.
              </li>
            </ul>
            <div className="mt-2">
              <a
