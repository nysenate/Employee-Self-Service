    ...
    <>
      ...
      <Card className="mt-3">
        {assignment.completed ? (
          <Card.Header>
            <p>
              ...
              {isoToLongDate(assignment.timestamp)}.<br />
              If you would like to review the video, you may still view it
              below.
            </p>
          </Card.Header>
        ) : (
          <Card.Header>
            ...
            <p>
              Please take some time to watch the video below.
              <br />
              Codes will appear on-screen at various points during the video.
              <br />
              Record these codes as they appear.
              <br />
              <span className={"font-semibold"}>
                You can scroll backwards in case you miss a code. You CANNOT
                scroll forwards
              </span>
              <br />
              When the video is finished, use the form below the video to enter
              the codes to confirm your viewing.
            </p>
          </Card.Header>
        )}
        ...
        <div className="w-full p-5">
          <RenderVideo
            src={assignment.task.path}
            allowSeeking={assignment.completed}
          />
        </div>
            ...
            <div className="border-t-1 border-solid border-teal-400">
              <Card.Header>
                <div className="font-semibold text-teal-700">
                  In the form below, please enter the codes from the video and
                  then click "Submit".
                </div>
              </Card.Header>
            </div>
