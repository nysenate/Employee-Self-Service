...
const DeactivateTaskModal = ({ isOpen, closeModal, empName, taskTitle, empId, taskId, onSubmit }) => {
  const style = {
    position: 'absolute',
    top: '50%',
    left: '50%',
      ...
      <Box sx={style}>
        ...
        <div className="py-1 mb-6">
          <p className="font-openSans text-center text-md">
            <u>Warning:</u> You are attempting to submit a task <b>ACTIVE STATUS</b> override for
            <br/>
...
export default DeactivateTaskModal;
