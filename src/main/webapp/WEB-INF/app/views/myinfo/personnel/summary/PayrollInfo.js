    ...
    <SummarySection>
      ...
      <SummarySection.Table>
        ...
        <SummarySection.Row>
          ...
          <SummarySection.Cell>
            {isoToShortDate(transactions["DTCONTSERV"].value)}
          </SummarySection.Cell>
        </SummarySection.Row>
        <SummarySection.Row>
          <SummarySection.Cell>
          ...
          <SummarySection.Cell>
            {toCurrency(transactions["MOSALBIWKLY"].value)}
          </SummarySection.Cell>
        </SummarySection.Row>
        {emp.payType === "TE" && (
          <SummarySection.Row>
            ...
            <SummarySection.Cell>
              {toCurrency(transactions["MOAMTEXCEED"].value)}
            </SummarySection.Cell>
          </SummarySection.Row>
        )}
        <SummarySection.Row>
          ...
          <SummarySection.Cell>
            {transactions["CDDIRECTDEPF"].value}
          </SummarySection.Cell>
        </SummarySection.Row>
        <SummarySection.Row>
