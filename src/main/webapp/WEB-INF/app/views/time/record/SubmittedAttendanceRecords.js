    ...
    <div className={styles.contentContainer}>
      ...
      <p className={styles.contentInfo}>
        ...
        {state.paperTimesheetsDisplayed && (
          <>
            <br />
            <span className={styles.bold}>Note:</span> Details are unavailable
            for attendance records entered via paper timesheet (designated by
            "(paper)" under Status)
          </>
        )}
      </p>
      <div className={styles.paddingX}>
        <table
          ...
          className={`${styles.essTable} ${styles.attendanceListingTable}`}
        >
          <thead>
            <tr>
              <th>Date Range</th>
          ...
          <tbody>
            {state.records.submitted.map((record) => (
              ...
              >
                <td>
                  {formatDateStandard(record.beginDate)} -{" "}
                  {formatDateStandard(record.endDate)}
                </td>
            ...
            <tr style={{ borderTop: "2px solid teal" }}>
              ...
              <td>
                <strong>{state.annualTotals.workHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.holidayHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.vacationHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.personalHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.sickEmpHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.sickFamHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.miscHours}</strong>
              </td>
              <td>
                <strong>{state.annualTotals.total}</strong>
              </td>
              <td></td>
            </tr>
          </tbody>
