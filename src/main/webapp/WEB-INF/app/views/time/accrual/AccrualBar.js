      ...
      {!(!loading && accruals) ? (
        ...
        <div className={styles.accrualHoursContainer}>
          <div className={styles.accrualComponent}>
            <div
              className={styles.captionedHourSquare}
              style={{ float: "left" }}
            >
              <div className={`${styles.hoursCaption} ${styles.personal}`}>
                Personal Hours
              </div>
              <div className={styles.hoursDisplay}>
                {accruals?.personalAvailable}
              </div>
            </div>
          </div>
          <div className={styles.accrualComponent}>
            <div
              ...
              style={{ float: "left" }}
            >
              <div className={`${styles.hoursCaption} ${styles.vacation}`}>
                Vacation Hours
              </div>
              <div className={styles.hoursDisplay}>
                {accruals?.vacationAvailable}
              </div>
            </div>
          </div>
          <div className={styles.accrualComponent}>
            <div
              ...
              style={{ float: "left" }}
            >
              <div className={`${styles.hoursCaption} ${styles.sick}`}>
                Sick Hours
              </div>
              <div className={`${styles.odometer} ${styles.hoursDisplay}`}>
                {accruals?.sickAvailable}
              </div>
            </div>
          </div>
          <div className={styles.accrualComponent}>
            ...
            >
              <div
                style={{ background: "#5c7474", color: "white" }}
              ...
              <div className={styles.hoursDisplay} style={{ fontSize: "1em" }}>
                ...
                <div className={styles.ytdHours}>
                  Actual: {accruals?.serviceYtd}
                </div>
                <div
                  className={styles.ytdHours}
