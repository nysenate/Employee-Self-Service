    ...
    >
      <div className={styles.grid}>
        <div className={`${styles.accrualDetailContent} ${styles.col1212}`}>
          <div
            className={`${styles.col1012} ${styles.accrualDetailTableContainer}`}
          >
            <div className={`${styles.col612}`}>
              ...
              <h4 className={`${styles.contentInfo} ${styles.sick}`}>
                Sick Hours
              </h4>
              <table className={styles.accrualDetailTable}>
                <tbody>
            ...
            <div className={`${styles.col612}`}>
              <h4 className={`${styles.contentInfo} ${styles.personal}`}>
                Personal Hours
              </h4>
              <table className={styles.accrualDetailTable}>
                <tbody>
              ...
              <h4 className={`${styles.contentInfo} ${styles.vacation}`}>
                Vacation Hours
              </h4>
              <table className={styles.accrualDetailTable}>
                <tbody>
