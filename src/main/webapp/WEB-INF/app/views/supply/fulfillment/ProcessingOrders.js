    ...
    return (
      <div>
        <div className={styles.contentContainer}>
          <h1 style={{ backgroundColor: "#4196A7", color: "white" }}>
    ...
    <div className={styles.contentContainer}>
      ...
      <div className={styles.contentInfo}>
        {requisitions.length === 0 ? (
          <h2 className={styles.darkGray}>No Processing Requests.</h2>
        ) : (
              ...
              {requisitions
                ...
                .map((requisition) => (
                  <tr
                    ...
                    className={calculateHighlighting(
                      requisition,
                  ...
                  >
                    <td
                      className={`${requisition.deliveryMethod === "PICKUP" && styles.supplyPickupIcon}`}
                    ></td>
