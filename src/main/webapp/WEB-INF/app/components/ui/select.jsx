  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-none border bg-gray-50",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "overflow-x-hidden overflow-y-auto rounded-none border shadow-md",
          position === "popper" &&
            cn(
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "w-full cursor-default items-center gap-2 rounded-none py-1.5 pr-8 pl-2 text-sm",
