    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed top-[50%] left-[50%] z-50 grid shadow-lg duration-200",
          "max-h-[calc(100%-2rem)] w-fit max-w-[calc(100%-2rem)] min-w-sm overflow-auto",
          "translate-x-[-50%] translate-y-[-50%] gap-4 rounded-none border",
          className,
        )}
        {...props}
      >
