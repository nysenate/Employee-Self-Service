<div class="padding-10">
  <h3 class="content-info margin-0">Travel Detail Information</h3>
  <div class="text-align-center">
    ...
    <div class="travel-gray-bottom-border clearfix padding-10 width-100">
      ...
      <p class="width-100 clearfix padding-top-10 text-align-center"><span class="bold">Total Allowance:</span> {{'$' + requestInfo.totalAllowance}}</p>
    </div>
