...
import gov.nysenate.ess.travel.approval.reviewer.MajReviewerStrategy;
...
@UnitTest
public class MajReviewerStrategyTest {

    private MajReviewerStrategy strategy;

    @Before
    public void setup() {
        strategy = new MajReviewerStrategy();
    }
